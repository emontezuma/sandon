...
export class CatalogosComponent implements OnInit {
  ...
  rRegistros(tabla: number)
  {
    ...
    else if (tabla == 999999)
    {
      ...
      sentencia = "SELECT a.id, a.nombre, IFNULL(d.nombre, '" + this.servicio.rTraduccion()[8] + "')  AS ncliente, a.estado, IFNULL(f.nombre, '" + this.servicio.rTraduccion()[3548] + "') AS nequipo, IF(a.estatus = 'A', '" + this.servicio.rTraduccion()[1154] + "', '" + this.servicio.rTraduccion()[1155] + "') AS estatus, IFNULL(c.nombre, '" + this.servicio.rTraduccion()[8] + "') AS ucambio, d.imagen FROM " + this.servicio.rBD() + ".cat_ordenes a LEFT JOIN " + this.servicio.rBD() + ".cat_usuarios b ON a.creado = b.id LEFT JOIN " + this.servicio.rBD() + ".cat_usuarios c ON a.modificado = c.id LEFT JOIN " + this.servicio.rBD() + ".cat_generales d ON a.cliente = d.id LEFT JOIN " + this.servicio.rBD() + ".cat_lineas f ON a.linea = f.id ORDER BY a.id DESC;";
    ...
    else if (tabla == 12)
    {
      ...
      this.sentenciaR = "SELECT '" + this.servicio.rTraduccion()[558] + "', '" + this.servicio.rTraduccion()[1328] + "', '" + this.servicio.rTraduccion()[1331] + "', '" + this.servicio.rTraduccion()[698] + "', '" + this.servicio.rTraduccion()[704] + "', '" + this.servicio.rTraduccion()[1197] + "', '" + this.servicio.rTraduccion()[1329] + "', '" + this.servicio.rTraduccion()[1332] + "', '" + this.servicio.rTraduccion()[1333] + "', '" + this.servicio.rTraduccion()[1334] + "', '" + this.servicio.rTraduccion()[3563] + "', '" + this.servicio.rTraduccion()[707] + "', '" + this.servicio.rTraduccion()[748] + "', '" + this.servicio.rTraduccion()[750] + "', '" + this.servicio.rTraduccion()[749] + "', '" + this.servicio.rTraduccion()[751] + "' UNION SELECT a.id, a.nombre, IFNULL(g.nombre, '" + this.servicio.rTraduccion()[8] + "'), a.referencia, a.notas, a.imagen, CASE WHEN a.rol ='*' THEN '" + this.servicio.rTraduccion()[1398] + "' WHEN a.rol = 'A' THEN '" + this.servicio.rTraduccion()[984] + "' WHEN a.rol = 'G' THEN '" + this.servicio.rTraduccion()[1022] + "' WHEN a.rol = 'S' THEN '" + this.servicio.rTraduccion()[1078] + "' WHEN a.rol = 'T' THEN '" + this.servicio.rTraduccion()[1399] + "' WHEN a.rol = 'O' THEN '" + this.servicio.rTraduccion()[1039] + "' END, IFNULL(d.nombre, '" + this.servicio.rTraduccion()[8] + "'), IFNULL(e.nombre, '" + this.servicio.rTraduccion()[8] + "'), IFNULL(f.nombre, '" + this.servicio.rTraduccion()[8] + "'), IFNULL(h.nombre, '" + this.servicio.rTraduccion()[8] + "'), IF(a.estatus = 'A', '" + this.servicio.rTraduccion()[1154] + "', '" + this.servicio.rTraduccion()[1155] + "'), a.creacion, IFNULL(b.nombre, '" + this.servicio.rTraduccion()[8] + "'), a.modificacion, IFNULL(c.nombre, '" + this.servicio.rTraduccion()[8] + "') FROM " + this.servicio.rBD() + ".cat_usuarios a LEFT JOIN " + this.servicio.rBD() + ".cat_usuarios b ON a.creado = b.id LEFT JOIN " + this.servicio.rBD() + ".cat_usuarios c ON a.modificado = c.id LEFT JOIN " + this.servicio.rBD() + ".cat_generales d ON a.compania = d.id LEFT JOIN " + this.servicio.rBD() + ".cat_generales e ON a.departamento = e.id LEFT JOIN " + this.servicio.rBD() + ".cat_generales f ON a.planta = f.id LEFT JOIN " + this.servicio.rBD() + ".cat_generales h ON a.cargo = h.id LEFT JOIN " + this.servicio.rBD() + ".politicas g ON a.politica = g.id    ";
    ...
    else if (tabla == 20)
    {
      ...
      sentencia = "SELECT a.*, CASE WHEN a.tipo = '0' THEN '" + this.servicio.rTraduccion()[1146] + "' WHEN a.tipo = '1' THEN '" + this.servicio.rTraduccion()[1125] + "' WHEN a.tipo = '2' THEN '" + this.servicio.rTraduccion()[1126] + "' WHEN a.tipo = '3' THEN '" + this.servicio.rTraduccion()[1117] + "' WHEN a.tipo = '4' THEN '" + this.servicio.rTraduccion()[1147] + "' END AS ntipo, CONCAT(d.nombre, ' / ', e.nombre) AS nequipo, e.nombre AS nlinea, a.modificacion, IF(a.estatus = 'A', '" + this.servicio.rTraduccion()[1154] + "', '" + this.servicio.rTraduccion()[1155] + "') AS estatus, IFNULL(c.nombre, '" + this.servicio.rTraduccion()[8] + "') AS ucambio FROM " + this.servicio.rBD() + ".relacion_procesos_sensores a LEFT JOIN " + this.servicio.rBD() + ".cat_usuarios b ON a.creado = b.id LEFT JOIN " + this.servicio.rBD() + ".cat_usuarios c ON a.modificado = c.id LEFT JOIN " + this.servicio.rBD() + ".cat_maquinas d ON a.equipo = d.id LEFT JOIN " + this.servicio.rBD() + ".cat_lineas e ON d.linea = e.id ORDER BY nequipo, a.sensor;";
      this.sentenciaR = "SELECT '" + this.servicio.rTraduccion()[744] + "', '" + this.servicio.rTraduccion()[1341] + "', '" + this.servicio.rTraduccion()[1342] + "', '" + this.servicio.rTraduccion()[1343] + "', '" + this.servicio.rTraduccion()[1344] + "', '" + this.servicio.rTraduccion()[743] + "', '" + this.servicio.rTraduccion()[580] + "', '" + this.servicio.rTraduccion()[581] + "', '" + this.servicio.rTraduccion()[1352] + "', '" + this.servicio.rTraduccion()[1353] + "', '" + this.servicio.rTraduccion()[707] + "', '" + this.servicio.rTraduccion()[748] + "', '" + this.servicio.rTraduccion()[750] + "', '" + this.servicio.rTraduccion()[749] + "', '" + this.servicio.rTraduccion()[751] + "' UNION SELECT a.sensor, d.nombre, e.nombre, a.equipo, d.linea, CASE WHEN a.tipo = '0' THEN '" + this.servicio.rTraduccion()[1146] + "' WHEN a.tipo = '1' THEN '" + this.servicio.rTraduccion()[1125] + "' WHEN a.tipo = '2' THEN '" + this.servicio.rTraduccion()[1126] + "' WHEN a.tipo = '3' THEN '" + this.servicio.rTraduccion()[1117] + "' WHEN a.tipo = '4' THEN '" + this.servicio.rTraduccion()[1147] + "' END AS ntipo, a.multiplicador, a.base, IFNULL(f.nombre, '" + this.servicio.rTraduccion()[8] + "'), IFNULL(g.nombre, '" + this.servicio.rTraduccion()[8] + "'), IF(a.estatus = 'A', '" + this.servicio.rTraduccion()[1154] + "', '" + this.servicio.rTraduccion()[1155] + "') AS estatus, a.creacion, IFNULL(b.nombre, '" + this.servicio.rTraduccion()[8] + "'), a.modificacion, IFNULL(c.nombre, '" + this.servicio.rTraduccion()[8] + "') FROM " + this.servicio.rBD() + ".relacion_procesos_sensores a LEFT JOIN " + this.servicio.rBD() + ".cat_usuarios b ON a.creado = b.id LEFT JOIN " + this.servicio.rBD() + ".cat_usuarios c ON a.modificado = c.id LEFT JOIN " + this.servicio.rBD() + ".cat_maquinas d ON a.equipo = d.id LEFT JOIN " + this.servicio.rBD() + ".cat_lineas e ON d.linea = e.id LEFT JOIN " + this.servicio.rBD() + ".cat_areas f ON a.area = f.id LEFT JOIN " + this.servicio.rBD() + ".cat_generales g ON a.clasificacion = g.id ";
    ...
    else if (tabla == 21)
    {
      ...
      this.sentenciaR = "SELECT * FROM (SELECT '" + this.servicio.rTraduccion()[1211] + "', '" + this.servicio.rTraduccion()[3781] + "', '" + this.servicio.rTraduccion()[697] + "', '" + this.servicio.rTraduccion()[1212] + "', '" + this.servicio.rTraduccion()[572] + "', '" + this.servicio.rTraduccion()[1354] + "', '" + this.servicio.rTraduccion()[1355] + "', '" + this.servicio.rTraduccion()[1356] + "', '" + this.servicio.rTraduccion()[698] + "', '" + this.servicio.rTraduccion()[1357] + "', '" + this.servicio.rTraduccion()[1358] + "', '" + this.servicio.rTraduccion()[1359] + "', '" + this.servicio.rTraduccion()[1360] + "', '" + this.servicio.rTraduccion()[1361] + "', '" + this.servicio.rTraduccion()[1362] + "', '" + this.servicio.rTraduccion()[1363] + "', '" + this.servicio.rTraduccion()[1364] + "', '" + this.servicio.rTraduccion()[3782] + "', '" + this.servicio.rTraduccion()[1365] + "', '" + this.servicio.rTraduccion()[1366] + "', '" + this.servicio.rTraduccion()[3783] + "', '" + this.servicio.rTraduccion()[1367] + "', '" + this.servicio.rTraduccion()[1368] + "', '" + this.servicio.rTraduccion()[1369] + "', '" + this.servicio.rTraduccion()[1370] + "', '" + this.servicio.rTraduccion()[1371] + "', '" + this.servicio.rTraduccion()[1372] + "' UNION (SELECT a.id, IF(a.clase = 0, '" + this.servicio.rTraduccion()[352] + "', '" + this.servicio.rTraduccion()[353] + "'), a.paro, a.fecha, IFNULL(b.nombre, '" + this.servicio.rTraduccion()[8] + "'), IFNULL(c.nombre, '" + this.servicio.rTraduccion()[8] + "'), IFNULL(d.nombre, '" + this.servicio.rTraduccion()[8] + "'), IFNULL(i.nombre, '" + this.servicio.rTraduccion()[8] + "'), IFNULL(i.referencia, '" + this.servicio.rTraduccion()[8] + "'), IFNULL(j.numero, '" + this.servicio.rTraduccion()[8] + "'), a.reporte, CASE WHEN a.clase = 0 THEN '" + this.servicio.rTraduccion()[303] + "' WHEN a.clase = 1 THEN '" + this.servicio.rTraduccion()[304] + "' WHEN a.clase = 2 THEN '" + this.servicio.rTraduccion()[305] + "' WHEN a.clase = 3 THEN '" + this.servicio.rTraduccion()[306] + "' WHEN a.clase = 4 THEN '" + this.servicio.rTraduccion()[3758] + "' END, IFNULL(e.nombre, '" + this.servicio.rTraduccion()[8] + "'), IFNULL(f.nombre, '" + this.servicio.rTraduccion()[8] + "'), CASE WHEN a.estado = 'P' THEN '" + this.servicio.rTraduccion()[1205] + "' WHEN a.estado = 'L' THEN '" + this.servicio.rTraduccion()[1206] + "' WHEN a.estado = 'C' THEN '" + this.servicio.rTraduccion()[1207] + "' WHEN a.estado = 'F' THEN '" + this.servicio.rTraduccion()[1208] + "' END, IF(a.clase = 0, a.desde, '" + this.servicio.rTraduccion()[8] + "'), IF(a.clase = 0, a.hasta, '" + this.servicio.rTraduccion()[8] + "'), IF(a.clase = 0, TIMEDIFF(a.hasta, a.desde), '" + this.servicio.rTraduccion()[8] + "'), a.inicia, a.finaliza, IF(a.tiempo = 0, TIMEDIFF(NOW(), a.inicia), TIMEDIFF(a.finaliza, a.inicia)), IF(a.tiempo = 0, TIME_TO_SEC(TIMEDIFF(NOW(), a.inicia)), a.tiempo), CASE WHEN a.finalizo_accion = 'P' THEN '" + this.servicio.rTraduccion()[3409] + "' WHEN a.finalizo_accion = 'T' THEN '" + this.servicio.rTraduccion()[3410] + "' WHEN a.finalizo_accion = 'M' THEN '" + this.servicio.rTraduccion()[3411] + "' WHEN a.finalizo_accion = 'R' THEN '" + this.servicio.rTraduccion()[3412] + "' WHEN a.finalizo_accion = 'O' THEN '" + this.servicio.rTraduccion()[3413] + "' END, IFNULL(g.nombre, '" + this.servicio.rTraduccion()[8] + "'), IFNULL(h.nombre, '" + this.servicio.rTraduccion()[8] + "'), a.notas, a.resultados FROM " + this.servicio.rBD() + ".detalleparos a LEFT JOIN " + this.servicio.rBD() + ".cat_turnos b ON a.turno = b.id LEFT JOIN " + this.servicio.rBD() + ".cat_maquinas c ON a.maquina = c.id LEFT JOIN " + this.servicio.rBD() + ".cat_lineas d ON c.linea = d.id LEFT JOIN " + this.servicio.rBD() + ".cat_generales e ON a.tipo = e.id LEFT JOIN " + this.servicio.rBD() + ".cat_generales f ON a.area = f.id LEFT JOIN " + this.servicio.rBD() + ".cat_usuarios g ON a.inicio = g.id LEFT JOIN " + this.servicio.rBD() + ".cat_usuarios h ON a.finalizo = h.id LEFT JOIN " + this.servicio.rBD() + ".cat_partes i ON a.parte = i.id LEFT JOIN " + this.servicio.rBD() + ".lotes j ON a.lote = j.id " + cadWhere + ")) AS a ORDER BY 1 DESC";
    ...
    else if (tabla == 25)
    {
      ...
      this.sentenciaR = "SELECT '" + this.servicio.rTraduccion()[558] + "', '" + this.servicio.rTraduccion()[697] + "', '" + this.servicio.rTraduccion()[698] + "', '" + this.servicio.rTraduccion()[665] + "', '" + this.servicio.rTraduccion()[704] + "', '" + this.servicio.rTraduccion()[1197] + "', '" + this.servicio.rTraduccion()[707] + "', '" + this.servicio.rTraduccion()[748] + "', '" + this.servicio.rTraduccion()[750] + "', '" + this.servicio.rTraduccion()[749] + "', '" + this.servicio.rTraduccion()[751] + "' UNION SELECT a.id, a.nombre, a.referencia, CASE WHEN a.tipo = 0 THEN '" + this.servicio.rTraduccion()[324] + "' WHEN a.tipo = 1 THEN '" + this.servicio.rTraduccion()[1023] + "' WHEN a.tipo = 2 THEN '" + this.servicio.rTraduccion()[988] + "' END, a.notas, a.imagen, IF(a.estatus = 'A', '" + this.servicio.rTraduccion()[1154] + "', '" + this.servicio.rTraduccion()[1155] + "'), a.creacion, IFNULL(b.nombre, '" + this.servicio.rTraduccion()[8] + "'), a.modificacion, IFNULL(c.nombre, '" + this.servicio.rTraduccion()[8] + "') FROM " + this.servicio.rBD() + ".cat_partes a LEFT JOIN " + this.servicio.rBD() + ".cat_usuarios b ON a.creado = b.id LEFT JOIN " + this.servicio.rBD() + ".cat_usuarios c ON a.modificado = c.id ";
  ...
  guardar()
  {
    ...
    else if (this.miSeleccion == 18)
    {
      ...
      else
      {
        ...
        sentencia = "INSERT INTO " + this.servicio.rBD() + ".equipos_objetivo (parte, equipo, lote, turno, fijo, desde, hasta, objetivo, reinicio) VALUES (" + this.detalle.parteID + ", " + this.detalle.equipo + ", " + miLote + ", " + this.detalle.turno + ", '" + this.detalle.fijo + "', " + (this.detalle.desde == "" ? "null" : "'" + this.servicio.fecha(2, this.detalle.desde, "yyyy/MM/dd") + "'")  + ", " + (this.detalle.hasta == "" ? "null" : "'" + this.servicio.fecha(2, this.detalle.hasta, "yyyy/MM/dd") + "'")  + ", " + this.detalle.objetivo + ", " + this.detalle.reinicio + ");UPDATE " + this.servicio.rBD() + ".actualizaciones SET objetivos = NOW();"
        if (this.detalle.id > 0)
        {
          sentencia = "UPDATE " + this.servicio.rBD() + ".equipos_objetivo SET parte = " + this.detalle.parteID + ", reinicio = " + this.detalle.reinicio + ", equipo = " + this.detalle.equipo + ", objetivo = " + this.detalle.objetivo + ", fijo = '" + this.detalle.fijo + "', turno = " + this.detalle.turno + ", lote = " + miLote + ", desde = " + (this.detalle.desde == "" ? "null" : "'" + this.servicio.fecha(2, this.detalle.desde, "yyyy/MM/dd") + "'")  + ", hasta = " + (this.detalle.hasta == "" ? "null" : "'" + this.servicio.fecha(2, this.detalle.hasta, "yyyy/MM/dd") + "'")  + " WHERE id = " + +this.detalle.id + ";UPDATE " + this.servicio.rBD() + ".actualizaciones SET objetivos = NOW();";
        }
        this.yaValidado = -1;
      }
    }
...
cambiando(evento: any)
  ...
  nuevo_siguiente()
  {
      ...
      {
        this.llenarListas(160, this.servicio.rBD() + ".cat_maquinas", " WHERE estatus = 'A'");
      ...
      {
        this.llenarListas(16, this.servicio.rBD() + ".cat_maquinas", " WHERE estatus = 'A' ");
        this.llenarListas(15, this.servicio.rBD() + ".cat_partes", " WHERE oee = 'S' "); 
      ...
      {
        this.llenarListas(20, this.servicio.rBD() + ".cat_maquinas", " WHERE estatus = 'A' ");
        this.llenarListas(5, this.servicio.rBD() + ".cat_areas", " WHERE estatus = 'A' ");
  ...
  listarListados(id: number)
  {
    ...
    filtroTabla = filtroTabla + ") "
    let sentencia = "SELECT a.id, a.nombre, a.modulo, IF(ISNULL(b.reporte), 0, 1) AS seleccionado FROM " + this.servicio.rBD() + ".int_listados a LEFT JOIN " + this.servicio.rBD() + ".det_correo b ON a.id = b.reporte AND b.correo = " + id + " WHERE a.estatus = 'A' AND a.idioma = " + this.servicio.rIdioma().id + " " + filtroTabla + " ORDER BY seleccionado DESC, a.orden;"
    this.listados = [];
    let campos = {accion: 100, sentencia: sentencia};  
    this.servicio.consultasBD(campos).subscribe( resp =>
    {
  ...
  {
    let sentencia = "SELECT a.id, a.nombre, IF(ISNULL(b.proceso), 0, 1) AS seleccionado FROM " + this.servicio.rBD() + ".cat_lineas a LEFT JOIN " + this.servicio.rBD() + ".relacion_ordenes_kanban b ON a.id = b.proceso AND b.tipo = 1 AND b.orden = " + id + " ORDER BY seleccionado DESC, a.nombre"
    if (id==0)
    {
  ...
  asociarTablasAlerta(id: number)
  {
    ...
    sentencia = "SELECT a.id, a.nombre, IF(ISNULL(b.proceso), 0, 1) AS seleccionado FROM " + this.servicio.rBD() + ".cat_procesos a LEFT JOIN " + this.servicio.rBD() + ".relacion_alertas_operaciones b ON a.id = b.proceso AND b.tipo = 5 AND b.alerta = " + id + " ORDER BY seleccionado DESC, a.nombre"
    if (id==0)
    {
