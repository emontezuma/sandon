...
export class GraficasComponent implements OnInit {
  ...
  buscarPeriodo(periodo: string, indice: number)
  {
    ...
    if (this.grActual<= 2)
    {
      sentencia = "SELECT 0 AS linea, '" + grupo + "' AS nombre, COUNT(*), e.tdias, SUM(e.lunes * IFNULL((SELECT lunes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.martes * IFNULL((SELECT martes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.miercoles * IFNULL((SELECT miercoles FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.jueves * IFNULL((SELECT jueves FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.viernes * IFNULL((SELECT viernes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.sabado * IFNULL((SELECT sabado FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.domingo * IFNULL((SELECT domingo FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0)) AS tdisponible, (SUM(e.lunes * IFNULL((SELECT lunes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.martes * IFNULL((SELECT martes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.miercoles * IFNULL((SELECT miercoles FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.jueves * IFNULL((SELECT jueves FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.viernes * IFNULL((SELECT viernes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.sabado * IFNULL((SELECT sabado FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.domingo * IFNULL((SELECT domingo FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0))) / (IFNULL(SUM(c.reps), 0) + 1) / 3600 AS mtbfc, IFNULL(SUM(c.reps), 0) AS docs, IFNULL(SUM(c.tiempo), 0) AS tiempo_c, IF(IFNULL(SUM(c.reps), 0) = 0, 0, IFNULL(SUM(c.tiempo), 0) / IFNULL(SUM(c.reps), 0) / 3600) AS mttrc, 0 AS pareto FROM " + this.servicio.rBD() + ".cat_maquinas a " + (this.grActual == 1 ? "INNER" : "LEFT") + " JOIN (SELECT maquina, linea, COUNT(*) AS reps, SUM(tiemporeparacion + tiempollegada) AS tiempo FROM " + this.servicio.rBD() + ".reportes c WHERE c.contabilizar = 'S' AND c.estatus >= 100  AND c.fecha_reporte >= '" + fDesde + "' AND c.fecha_reporte <= '" + fHasta + "' " + (periodo != "1" ? this.filtroReportes : "") + " GROUP BY maquina, linea) AS c ON a.id = c.maquina LEFT JOIN " + this.servicio.rBD() + ".cat_lineas b ON a.linea = b.id, (SELECT COUNT(*) AS tdias, SUM(IF(dia = 2, 1, 0)) AS lunes, SUM(IF(dia = 3, 1, 0)) AS martes, SUM(IF(dia = 4, 1, 0)) AS miercoles, SUM(IF(dia = 5, 1, 0)) AS jueves, SUM(IF(dia = 6, 1, 0)) AS viernes, SUM(IF(dia = 7, 1, 0)) AS sabado, SUM(IF(dia = 1, 1, 0)) AS domingo FROM " + this.servicio.rBD() + ".dias WHERE  fecha >= '" + fDesde + "' AND fecha <= '" + fHasta + "' ) AS e " + (this.grActual == 1 ? "" : "WHERE a.id > 0 " + (periodo != "1" ? this.filtroMTBF : ""));
      
      if (this.graficaActual == 2)
      {
        sentencia = "SELECT 0 AS id, '" + grupo + "' AS nombre, e.tdias, SUM(e.lunes * IFNULL((SELECT lunes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.martes * IFNULL((SELECT martes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.miercoles * IFNULL((SELECT miercoles FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.jueves * IFNULL((SELECT jueves FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.viernes * IFNULL((SELECT viernes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.sabado * IFNULL((SELECT sabado FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.domingo * IFNULL((SELECT domingo FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0)) AS tdisponible, (SUM(e.lunes * IFNULL((SELECT lunes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.martes * IFNULL((SELECT martes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.miercoles * IFNULL((SELECT miercoles FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.jueves * IFNULL((SELECT jueves FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.viernes * IFNULL((SELECT viernes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.sabado * IFNULL((SELECT sabado FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.domingo * IFNULL((SELECT domingo FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0))) / (IFNULL(SUM(c.reps), 0) + 1) / 3600 AS mtbfc, IFNULL(SUM(c.reps), 0) AS docs, IFNULL(SUM(c.tiempo), 0) AS tiempo_c, IF(IFNULL(SUM(c.reps), 0) = 0, 0, IFNULL(SUM(c.tiempo), 0) / IFNULL(SUM(c.reps), 0) / 3600) AS mttrc, 0 AS pareto FROM " + this.servicio.rBD() + ".cat_maquinas a " + (this.grActual == 1 ? "INNER" : "LEFT") + " JOIN (SELECT linea, maquina, COUNT(*) AS reps, SUM(tiemporeparacion + tiempollegada) AS tiempo FROM " + this.servicio.rBD() + ".reportes c WHERE c.contabilizar = 'S' AND c.estatus >= 100  AND c.fecha_reporte >= '" + fDesde + "' AND c.fecha_reporte <= '" + fHasta + "' " + (periodo != "1" ? this.filtroReportes : "") + " GROUP BY linea, maquina) AS c ON a.id = c.maquina, (SELECT COUNT(*) AS tdias, SUM(IF(dia = 2, 1, 0)) AS lunes, SUM(IF(dia = 3, 1, 0)) AS martes, SUM(IF(dia = 4, 1, 0)) AS miercoles, SUM(IF(dia = 5, 1, 0)) AS jueves, SUM(IF(dia = 6, 1, 0)) AS viernes, SUM(IF(dia = 7, 1, 0)) AS sabado, SUM(IF(dia = 1, 1, 0)) AS domingo FROM " + this.servicio.rBD() + ".dias WHERE  fecha >= '" + fDesde + "' AND fecha <= '" + fHasta + "' ) AS e " + (this.grActual == 1 ? "" : "WHERE a.id > 0 " + (periodo != "1" ? this.filtroMTBF : ""));;
      }
      else if (this.graficaActual == 3)
      {
        sentencia = "SELECT 0 AS id, '" + grupo + "' AS nombre, e.tdias, (e.lunes + e.martes + e.miercoles + e.jueves + e.viernes + e.sabado + e.domingo) AS tdisponible, (e.lunes + e.martes + e.miercoles + e.jueves + e.viernes + e.sabado + e.domingo) / (IFNULL(SUM(c.reps), 0) + 1) / 3600 AS mtbfc, IFNULL(SUM(c.reps), 0) AS docs, IFNULL(SUM(c.tiempo), 0) AS tiempo_c, IF(IFNULL(SUM(c.reps), 0) = 0, 0, IFNULL(SUM(c.tiempo), 0) / IFNULL(SUM(c.reps), 0) / 3600) AS mttrc, 0 AS pareto FROM " + this.servicio.rBD() + ".cat_areas a " + (this.grActual == 1 ? "INNER" : "LEFT") + " JOIN (SELECT AREA, linea, maquina, COUNT(*) AS reps, SUM(tiemporeparacion + tiempollegada) AS tiempo FROM " + this.servicio.rBD() + ".reportes c WHERE c.contabilizar = 'S' AND c.estatus >= 100  AND c.fecha_reporte >= '" + fDesde + "' AND c.fecha_reporte <= '" + fHasta + "' " + (periodo != "1" ? this.filtroReportes : "") + " GROUP BY AREA, linea, maquina) AS c ON a.id = c.AREA, (SELECT COUNT(*) AS tdias, SUM(IF(dia = 2, 1, 0)) * IFNULL((SELECT lunes FROM " + this.servicio.rBD() + ".disponibilidad WHERE estatus = 'A' AND linea = 0 AND maquina = 0 LIMIT 1), 0) AS lunes, SUM(IF(dia = 3, 1, 0)) * IFNULL((SELECT martes FROM " + this.servicio.rBD() + ".disponibilidad WHERE estatus = 'A' AND linea = 0 AND maquina = 0 LIMIT 1), 0) AS martes, SUM(IF(dia = 4, 1, 0)) * IFNULL((SELECT miercoles FROM " + this.servicio.rBD() + ".disponibilidad WHERE estatus = 'A' AND linea = 0 AND maquina = 0 LIMIT 1), 0) AS miercoles, SUM(IF(dia = 5, 1, 0)) * IFNULL((SELECT jueves FROM " + this.servicio.rBD() + ".disponibilidad WHERE estatus = 'A' AND linea = 0 AND maquina = 0 LIMIT 1), 0) AS jueves, SUM(IF(dia = 6, 1, 0)) * IFNULL((SELECT viernes FROM " + this.servicio.rBD() + ".disponibilidad WHERE estatus = 'A' AND linea = 0 AND maquina = 0 LIMIT 1), 0) AS viernes, SUM(IF(dia = 7, 1, 0)) * IFNULL((SELECT sabado FROM " + this.servicio.rBD() + ".disponibilidad WHERE estatus = 'A' AND linea = 0 AND maquina = 0 LIMIT 1), 0) AS sabado, SUM(IF(dia = 1, 1, 0)) * IFNULL((SELECT domingo FROM " + this.servicio.rBD() + ".disponibilidad WHERE estatus = 'A' AND linea = 0 AND maquina = 0 LIMIT 1), 0) AS domingo FROM " + this.servicio.rBD() + ".dias WHERE  fecha >= '" + fDesde + "' AND fecha <= '" + fHasta + "' ) AS e " + (this.grActual == 1 ? "" : "WHERE a.id > 0 " + (periodo != "1" ? this.filtroMTBF_are : "")) ;
      }
      else if (this.graficaActual == 4)
      {
        sentencia = "SELECT 0 AS id, '" + grupo + "' AS nombre, e.tdias, (e.lunes + e.martes + e.miercoles + e.jueves + e.viernes + e.sabado + e.domingo) AS tdisponible, (e.lunes + e.martes + e.miercoles + e.jueves + e.viernes + e.sabado + e.domingo) / (IFNULL(SUM(c.reps), 0) + 1) / 3600 AS mtbfc, IFNULL(SUM(c.reps), 0) AS docs, IFNULL(SUM(c.tiempo), 0) AS tiempo_c, IF(IFNULL(SUM(c.reps), 0) = 0, 0, IFNULL(SUM(c.tiempo), 0) / IFNULL(SUM(c.reps), 0) / 3600) AS mttrc, 0 AS pareto FROM " + this.servicio.rBD() + ".cat_fallas a " + (this.grActual == 1 ? "INNER" : "LEFT") + " JOIN (SELECT falla_ajustada, linea, maquina, COUNT(*) AS reps, SUM(tiemporeparacion + tiempollegada) AS tiempo FROM " + this.servicio.rBD() + ".reportes c WHERE c.contabilizar = 'S' AND c.estatus >= 100  AND c.fecha_reporte >= '" + fDesde + "' AND c.fecha_reporte <= '" + fHasta + "' " + (periodo != "1" ? this.filtroReportes : "") + " GROUP BY falla_ajustada, linea, maquina) AS c ON a.id = c.falla_ajustada, (SELECT COUNT(*) AS tdias, SUM(IF(dia = 2, 1, 0)) * IFNULL((SELECT lunes FROM " + this.servicio.rBD() + ".disponibilidad WHERE estatus = 'A' AND linea = 0 AND maquina = 0 LIMIT 1), 0) AS lunes, SUM(IF(dia = 3, 1, 0)) * IFNULL((SELECT martes FROM " + this.servicio.rBD() + ".disponibilidad WHERE estatus = 'A' AND linea = 0 AND maquina = 0 LIMIT 1), 0) AS martes, SUM(IF(dia = 4, 1, 0)) * IFNULL((SELECT miercoles FROM " + this.servicio.rBD() + ".disponibilidad WHERE estatus = 'A' AND linea = 0 AND maquina = 0 LIMIT 1), 0) AS miercoles, SUM(IF(dia = 5, 1, 0)) * IFNULL((SELECT jueves FROM " + this.servicio.rBD() + ".disponibilidad WHERE estatus = 'A' AND linea = 0 AND maquina = 0 LIMIT 1), 0) AS jueves, SUM(IF(dia = 6, 1, 0)) * IFNULL((SELECT viernes FROM " + this.servicio.rBD() + ".disponibilidad WHERE estatus = 'A' AND linea = 0 AND maquina = 0 LIMIT 1), 0) AS viernes, SUM(IF(dia = 7, 1, 0)) * IFNULL((SELECT sabado FROM " + this.servicio.rBD() + ".disponibilidad WHERE estatus = 'A' AND linea = 0 AND maquina = 0 LIMIT 1), 0) AS sabado, SUM(IF(dia = 1, 1, 0)) * IFNULL((SELECT domingo FROM " + this.servicio.rBD() + ".disponibilidad WHERE estatus = 'A' AND linea = 0 AND maquina = 0 LIMIT 1), 0) AS domingo FROM " + this.servicio.rBD() + ".dias WHERE  fecha >= '" + fDesde + "' AND fecha <= '" + fHasta + "' ) AS e " + (this.grActual == 1 ? "" : "WHERE a.id > 0 " + (periodo != "1" ? this.filtroMTBF_fal : ""));
      }
      else if (this.graficaActual == 5)
      {
        sentencia = "SELECT 0 AS tipo, '" + grupo + "' AS nombre, COUNT(*), e.tdias, SUM(e.lunes * IFNULL((SELECT lunes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.martes * IFNULL((SELECT martes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.miercoles * IFNULL((SELECT miercoles FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.jueves * IFNULL((SELECT jueves FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.viernes * IFNULL((SELECT viernes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.sabado * IFNULL((SELECT sabado FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.domingo * IFNULL((SELECT domingo FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0)) AS tdisponible, (SUM(e.lunes * IFNULL((SELECT lunes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.martes * IFNULL((SELECT martes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.miercoles * IFNULL((SELECT miercoles FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.jueves * IFNULL((SELECT jueves FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.viernes * IFNULL((SELECT viernes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.sabado * IFNULL((SELECT sabado FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.domingo * IFNULL((SELECT domingo FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0))) / (IFNULL(SUM(c.reps), 0) + 1) / 3600 AS mtbfc, IFNULL(SUM(c.reps), 0) AS docs, IFNULL(SUM(c.tiempo), 0) AS tiempo_c, IF(IFNULL(SUM(c.reps), 0) = 0, 0, IFNULL(SUM(c.tiempo), 0) / IFNULL(SUM(c.reps), 0) / 3600) AS mttrc, 0 AS pareto FROM " + this.servicio.rBD() + ".cat_maquinas a " + (this.grActual == 1 ? "INNER" : "LEFT") + " JOIN (SELECT maquina, linea, COUNT(*) AS reps, SUM(tiemporeparacion + tiempollegada) AS tiempo FROM " + this.servicio.rBD() + ".reportes c WHERE c.contabilizar = 'S' AND c.estatus >= 100  AND c.fecha_reporte >= '" + fDesde + "' AND c.fecha_reporte <= '" + fHasta + "' " + (periodo != "1" ? this.filtroReportes : "") + " GROUP BY maquina, linea) AS c ON a.id = c.maquina LEFT JOIN " + this.servicio.rBD() + ".cat_generales b ON a.tipo = b.id AND b.tabla = 50, (SELECT COUNT(*) AS tdias, SUM(IF(dia = 2, 1, 0)) AS lunes, SUM(IF(dia = 3, 1, 0)) AS martes, SUM(IF(dia = 4, 1, 0)) AS miercoles, SUM(IF(dia = 5, 1, 0)) AS jueves, SUM(IF(dia = 6, 1, 0)) AS viernes, SUM(IF(dia = 7, 1, 0)) AS sabado, SUM(IF(dia = 1, 1, 0)) AS domingo FROM " + this.servicio.rBD() + ".dias WHERE  fecha >= '" + fDesde + "' AND fecha <= '" + fHasta + "' ) AS e " + (this.grActual == 1 ? "" : "WHERE a.id > 0 " + (periodo != "1" ? this.filtroMTBF : ""));
      }
      else if (this.graficaActual == 6)
      {
        sentencia = "SELECT 0 AS agrupador_1, '" + grupo + "' AS nombre, COUNT(*), e.tdias, SUM(e.lunes * IFNULL((SELECT lunes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.martes * IFNULL((SELECT martes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.miercoles * IFNULL((SELECT miercoles FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.jueves * IFNULL((SELECT jueves FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.viernes * IFNULL((SELECT viernes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.sabado * IFNULL((SELECT sabado FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.domingo * IFNULL((SELECT domingo FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0)) AS tdisponible, (SUM(e.lunes * IFNULL((SELECT lunes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.martes * IFNULL((SELECT martes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.miercoles * IFNULL((SELECT miercoles FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.jueves * IFNULL((SELECT jueves FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.viernes * IFNULL((SELECT viernes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.sabado * IFNULL((SELECT sabado FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.domingo * IFNULL((SELECT domingo FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0))) / (IFNULL(SUM(c.reps), 0) + 1) / 3600 AS mtbfc, IFNULL(SUM(c.reps), 0) AS docs, IFNULL(SUM(c.tiempo), 0) AS tiempo_c, IF(IFNULL(SUM(c.reps), 0) = 0, 0, IFNULL(SUM(c.tiempo), 0) / IFNULL(SUM(c.reps), 0) / 3600) AS mttrc, 0 AS pareto FROM " + this.servicio.rBD() + ".cat_maquinas a " + (this.grActual == 1 ? "INNER" : "LEFT") + " JOIN (SELECT maquina, linea, COUNT(*) AS reps, SUM(tiemporeparacion + tiempollegada) AS tiempo FROM " + this.servicio.rBD() + ".reportes c WHERE c.contabilizar = 'S' AND c.estatus >= 100  AND c.fecha_reporte >= '" + fDesde + "' AND c.fecha_reporte <= '" + fHasta + "' " + (periodo != "1" ? this.filtroReportes : "") + " GROUP BY maquina, linea) AS c ON a.id = c.maquina LEFT JOIN " + this.servicio.rBD() + ".cat_generales b ON a.agrupador_1 = b.id AND b.tabla = 20, (SELECT COUNT(*) AS tdias, SUM(IF(dia = 2, 1, 0)) AS lunes, SUM(IF(dia = 3, 1, 0)) AS martes, SUM(IF(dia = 4, 1, 0)) AS miercoles, SUM(IF(dia = 5, 1, 0)) AS jueves, SUM(IF(dia = 6, 1, 0)) AS viernes, SUM(IF(dia = 7, 1, 0)) AS sabado, SUM(IF(dia = 1, 1, 0)) AS domingo FROM " + this.servicio.rBD() + ".dias WHERE  fecha >= '" + fDesde + "' AND fecha <= '" + fHasta + "' ) AS e " + (this.grActual == 1 ? "" : "WHERE a.id > 0 " + (periodo != "1" ? this.filtroMTBF : ""));
      }
      else if (this.graficaActual == 7)
      {
        sentencia = "SELECT 0 AS agrupador_2, '" + grupo + "' AS nombre, COUNT(*), e.tdias, SUM(e.lunes * IFNULL((SELECT lunes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.martes * IFNULL((SELECT martes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.miercoles * IFNULL((SELECT miercoles FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.jueves * IFNULL((SELECT jueves FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.viernes * IFNULL((SELECT viernes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.sabado * IFNULL((SELECT sabado FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.domingo * IFNULL((SELECT domingo FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0)) AS tdisponible, (SUM(e.lunes * IFNULL((SELECT lunes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.martes * IFNULL((SELECT martes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.miercoles * IFNULL((SELECT miercoles FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.jueves * IFNULL((SELECT jueves FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.viernes * IFNULL((SELECT viernes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.sabado * IFNULL((SELECT sabado FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.domingo * IFNULL((SELECT domingo FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0))) / (IFNULL(SUM(c.reps), 0) + 1) / 3600 AS mtbfc, IFNULL(SUM(c.reps), 0) AS docs, IFNULL(SUM(c.tiempo), 0) AS tiempo_c, IF(IFNULL(SUM(c.reps), 0) = 0, 0, IFNULL(SUM(c.tiempo), 0) / IFNULL(SUM(c.reps), 0) / 3600) AS mttrc, 0 AS pareto FROM " + this.servicio.rBD() + ".cat_maquinas a " + (this.grActual == 1 ? "INNER" : "LEFT") + " JOIN (SELECT maquina, linea, COUNT(*) AS reps, SUM(tiemporeparacion + tiempollegada) AS tiempo FROM " + this.servicio.rBD() + ".reportes c WHERE c.contabilizar = 'S' AND c.estatus >= 100  AND c.fecha_reporte >= '" + fDesde + "' AND c.fecha_reporte <= '" + fHasta + "' " + (periodo != "1" ? this.filtroReportes : "") + " GROUP BY maquina, linea) AS c ON a.id = c.maquina LEFT JOIN " + this.servicio.rBD() + ".cat_generales b ON a.agrupador_2 = b.id AND b.tabla = 25, (SELECT COUNT(*) AS tdias, SUM(IF(dia = 2, 1, 0)) AS lunes, SUM(IF(dia = 3, 1, 0)) AS martes, SUM(IF(dia = 4, 1, 0)) AS miercoles, SUM(IF(dia = 5, 1, 0)) AS jueves, SUM(IF(dia = 6, 1, 0)) AS viernes, SUM(IF(dia = 7, 1, 0)) AS sabado, SUM(IF(dia = 1, 1, 0)) AS domingo FROM " + this.servicio.rBD() + ".dias WHERE  fecha >= '" + fDesde + "' AND fecha <= '" + fHasta + "' ) AS e " + (this.grActual == 1 ? "" : "WHERE a.id > 0 " + (periodo != "1" ? this.filtroMTBF : ""));
      }
      else if (this.graficaActual == 8)
      {
        sentencia = "SELECT 0 AS agrupador_1, '" + grupo + "' AS nombre, COUNT(*), e.tdias, SUM(e.lunes * IFNULL((SELECT lunes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.martes * IFNULL((SELECT martes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.miercoles * IFNULL((SELECT miercoles FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.jueves * IFNULL((SELECT jueves FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.viernes * IFNULL((SELECT viernes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.sabado * IFNULL((SELECT sabado FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.domingo * IFNULL((SELECT domingo FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0)) AS tdisponible, (SUM(e.lunes * IFNULL((SELECT lunes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.martes * IFNULL((SELECT martes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.miercoles * IFNULL((SELECT miercoles FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.jueves * IFNULL((SELECT jueves FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.viernes * IFNULL((SELECT viernes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.sabado * IFNULL((SELECT sabado FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.domingo * IFNULL((SELECT domingo FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0))) / (IFNULL(SUM(c.reps), 0) + 1) / 3600 AS mtbfc, IFNULL(SUM(c.reps), 0) AS docs, IFNULL(SUM(c.tiempo), 0) AS tiempo_c, IF(IFNULL(SUM(c.reps), 0) = 0, 0, IFNULL(SUM(c.tiempo), 0) / IFNULL(SUM(c.reps), 0) / 3600) AS mttrc, 0 AS pareto FROM " + this.servicio.rBD() + ".cat_fallas a " + (this.grActual == 1 ? "INNER" : "LEFT") + " JOIN (SELECT falla_ajustada, maquina, linea, COUNT(*) AS reps, SUM(tiemporeparacion + tiempollegada) AS tiempo FROM " + this.servicio.rBD() + ".reportes c WHERE c.contabilizar = 'S' AND c.estatus >= 100  AND c.fecha_reporte >= '" + fDesde + "' AND c.fecha_reporte <= '" + fHasta + "' " + (periodo != "1" ? this.filtroReportes : "") + " GROUP BY falla_ajustada, maquina, linea) AS c ON a.id = c.falla_ajustada LEFT JOIN " + this.servicio.rBD() + ".cat_generales b ON a.agrupador_1 = b.id AND b.tabla = 40, (SELECT COUNT(*) AS tdias, SUM(IF(dia = 2, 1, 0)) AS lunes, SUM(IF(dia = 3, 1, 0)) AS martes, SUM(IF(dia = 4, 1, 0)) AS miercoles, SUM(IF(dia = 5, 1, 0)) AS jueves, SUM(IF(dia = 6, 1, 0)) AS viernes, SUM(IF(dia = 7, 1, 0)) AS sabado, SUM(IF(dia = 1, 1, 0)) AS domingo FROM " + this.servicio.rBD() + ".dias WHERE  fecha >= '" + fDesde + "' AND fecha <= '" + fHasta + "' ) AS e " + (this.grActual == 1 ? "" : "WHERE a.id > 0 " + (periodo != "1" ? this.filtroMTBF_fal : ""));
      }
      else if (this.graficaActual == 9)
      {
        sentencia = "SELECT 0 AS agrupador_2, '" + grupo + "' AS nombre, COUNT(*), e.tdias, SUM(e.lunes * IFNULL((SELECT lunes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.martes * IFNULL((SELECT martes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.miercoles * IFNULL((SELECT miercoles FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.jueves * IFNULL((SELECT jueves FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.viernes * IFNULL((SELECT viernes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.sabado * IFNULL((SELECT sabado FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.domingo * IFNULL((SELECT domingo FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0)) AS tdisponible, (SUM(e.lunes * IFNULL((SELECT lunes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.martes * IFNULL((SELECT martes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.miercoles * IFNULL((SELECT miercoles FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.jueves * IFNULL((SELECT jueves FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.viernes * IFNULL((SELECT viernes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.sabado * IFNULL((SELECT sabado FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.domingo * IFNULL((SELECT domingo FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0))) / (IFNULL(SUM(c.reps), 0) + 1) / 3600 AS mtbfc, IFNULL(SUM(c.reps), 0) AS docs, IFNULL(SUM(c.tiempo), 0) AS tiempo_c, IF(IFNULL(SUM(c.reps), 0) = 0, 0, IFNULL(SUM(c.tiempo), 0) / IFNULL(SUM(c.reps), 0) / 3600) AS mttrc, 0 AS pareto FROM " + this.servicio.rBD() + ".cat_fallas a " + (this.grActual == 1 ? "INNER" : "LEFT") + " JOIN (SELECT falla_ajustada, maquina, linea, COUNT(*) AS reps, SUM(tiemporeparacion + tiempollegada) AS tiempo FROM " + this.servicio.rBD() + ".reportes c WHERE c.contabilizar = 'S' AND c.estatus >= 100  AND c.fecha_reporte >= '" + fDesde + "' AND c.fecha_reporte <= '" + fHasta + "' " + (periodo != "1" ? this.filtroReportes : "") + " GROUP BY falla_ajustada, maquina, linea) AS c ON a.id = c.falla_ajustada LEFT JOIN " + this.servicio.rBD() + ".cat_generales b ON a.agrupador_2 = b.id AND b.tabla = 45, (SELECT COUNT(*) AS tdias, SUM(IF(dia = 2, 1, 0)) AS lunes, SUM(IF(dia = 3, 1, 0)) AS martes, SUM(IF(dia = 4, 1, 0)) AS miercoles, SUM(IF(dia = 5, 1, 0)) AS jueves, SUM(IF(dia = 6, 1, 0)) AS viernes, SUM(IF(dia = 7, 1, 0)) AS sabado, SUM(IF(dia = 1, 1, 0)) AS domingo FROM " + this.servicio.rBD() + ".dias WHERE  fecha >= '" + fDesde + "' AND fecha <= '" + fHasta + "' ) AS e " + (this.grActual == 1 ? "" : "WHERE a.id > 0 " + (periodo != "1" ? this.filtroMTBF_fal : ""));
      }
      else if (this.graficaActual == 10)
      {
        sentencia = "SELECT '" + grupo + "' AS nombre, IFNULL(IF(a.dia = 1, g.domingo, IF(a.dia = 2, g.lunes, IF(a.dia = 3, g.martes, IF(a.dia = 4, g.miercoles, IF(a.dia = 5, g.jueves, IF(a.dia = 6, g.viernes, g.sabado)))))), 0) AS tdisponible, IFNULL(IF(a.dia = 1, g.domingo, IF(a.dia = 2, g.lunes, IF(a.dia = 3, g.martes, IF(a.dia = 4, g.miercoles, IF(a.dia = 5, g.jueves, IF(a.dia = 6, g.viernes, g.sabado)))))), 0) / (IFNULL(SUM(c.reps), 0) + 1) / 3600 AS mtbfc, IFNULL(SUM(c.reps), 0) AS docs, IFNULL(SUM(c.tiempo), 0) AS tiempo_c, IF(IFNULL(SUM(c.reps), 0) = 0, 0, IFNULL(SUM(c.tiempo), 0) / IFNULL(SUM(c.reps), 0) / 3600) AS mttrc, 0 AS pareto FROM " + this.servicio.rBD() + ".dias a " + (this.grActual == 1 ? "INNER" : "LEFT") + " JOIN (SELECT fecha_reporte, COUNT(*) AS reps, SUM(tiemporeparacion + tiempollegada) AS tiempo FROM " + this.servicio.rBD() + ".reportes c WHERE c.contabilizar = 'S' AND c.estatus >= 100  AND c.fecha_reporte >= '" + fDesde + "' AND c.fecha_reporte <= '" + fHasta + "' " + (periodo != "1" ? this.filtroReportes : "") + " GROUP BY fecha_reporte) AS c ON a.fecha = c.fecha_reporte, (SELECT * FROM " + this.servicio.rBD() + ".disponibilidad WHERE estatus = 'A' AND maquina = 0 AND linea = 0 LIMIT 1) AS g WHERE  fecha >= '" + fDesde + "' AND fecha <= '" + fHasta + "' ";
      }
      else if (this.graficaActual == 11)
      {
      ...
      {
        sentencia = "SELECT 0 AS id, '" + grupo + "' AS nombre, e.tdias, (e.lunes + e.martes + e.miercoles + e.jueves + e.viernes + e.sabado + e.domingo) AS tdisponible, (e.lunes + e.martes + e.miercoles + e.jueves + e.viernes + e.sabado + e.domingo) / (IFNULL(SUM(c.reps), 0) + 1) / 3600 AS mtbfc, IFNULL(SUM(c.reps), 0) AS docs, IFNULL(SUM(c.tiempo), 0) AS tiempo_c, IF(IFNULL(SUM(c.reps), 0) = 0, 0, IFNULL(SUM(c.tiempo), 0) / IFNULL(SUM(c.reps), 0) / 3600) AS mttrc, 0 AS pareto FROM " + this.servicio.rBD() + ".cat_usuarios a " + (this.grActual == 1 ? "INNER" : "LEFT") + " JOIN (SELECT tecnicoatend, maquina, COUNT(*) AS reps, SUM(tiemporeparacion + tiempollegada) AS tiempo FROM " + this.servicio.rBD() + ".reportes c WHERE c.contabilizar = 'S' AND c.estatus >= 100  AND c.fecha_reporte >= '" + fDesde + "' AND c.fecha_reporte <= '" + fHasta + "' " + (periodo != "1" ? this.filtroReportes : "") + " GROUP BY tecnicoatend, maquina) AS c ON a.id = c.tecnicoatend, (SELECT COUNT(*) AS tdias, SUM(IF(dia = 2, 1, 0)) * IFNULL((SELECT lunes FROM " + this.servicio.rBD() + ".disponibilidad WHERE estatus = 'A' AND linea = 0 AND maquina = 0 LIMIT 1), 0) AS lunes, SUM(IF(dia = 3, 1, 0)) * IFNULL((SELECT martes FROM " + this.servicio.rBD() + ".disponibilidad WHERE estatus = 'A' AND linea = 0 AND maquina = 0 LIMIT 1), 0) AS martes, SUM(IF(dia = 4, 1, 0)) * IFNULL((SELECT miercoles FROM " + this.servicio.rBD() + ".disponibilidad WHERE estatus = 'A' AND linea = 0 AND maquina = 0 LIMIT 1), 0) AS miercoles, SUM(IF(dia = 5, 1, 0)) * IFNULL((SELECT jueves FROM " + this.servicio.rBD() + ".disponibilidad WHERE estatus = 'A' AND linea = 0 AND maquina = 0 LIMIT 1), 0) AS jueves, SUM(IF(dia = 6, 1, 0)) * IFNULL((SELECT viernes FROM " + this.servicio.rBD() + ".disponibilidad WHERE estatus = 'A' AND linea = 0 AND maquina = 0 LIMIT 1), 0) AS viernes, SUM(IF(dia = 7, 1, 0)) * IFNULL((SELECT sabado FROM " + this.servicio.rBD() + ".disponibilidad WHERE estatus = 'A' AND linea = 0 AND maquina = 0 LIMIT 1), 0) AS sabado, SUM(IF(dia = 1, 1, 0)) * IFNULL((SELECT domingo FROM " + this.servicio.rBD() + ".disponibilidad WHERE estatus = 'A' AND linea = 0 AND maquina = 0 LIMIT 1), 0) AS domingo FROM " + this.servicio.rBD() + ".dias WHERE  fecha >= '" + fDesde + "' AND fecha <= '" + fHasta + "' ) AS e " + (this.grActual == 1 ? "" : "WHERE a.id > 0 " + (periodo != "1" ? this.filtroMTBF_tec : ""));
      }
    }
    else if (this.grActual == 4)
    {
    ...
    this.servicio.consultasBD(campos).subscribe( resp =>
    {
      ...
      this.parGrafica.overlap = (this.parGrafica.overlap == "R" || this.parGrafica.overlap == "rotate" ? "rotate" : "stagger");
        ...
        if (this.grActual <= 2)
        {
          ...
          sentencia = "SELECT a.linea, b.nombre, COUNT(*), e.tdias, SUM(e.lunes * IFNULL((SELECT lunes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.martes * IFNULL((SELECT martes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.miercoles * IFNULL((SELECT miercoles FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.jueves * IFNULL((SELECT jueves FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.viernes * IFNULL((SELECT viernes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.sabado * IFNULL((SELECT sabado FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.domingo * IFNULL((SELECT domingo FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0)) AS tdisponible, (SUM(e.lunes * IFNULL((SELECT lunes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.martes * IFNULL((SELECT martes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.miercoles * IFNULL((SELECT miercoles FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.jueves * IFNULL((SELECT jueves FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.viernes * IFNULL((SELECT viernes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.sabado * IFNULL((SELECT sabado FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.domingo * IFNULL((SELECT domingo FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0))) / (IFNULL(SUM(c.reps), 0) + 1) / 3600 AS mtbfc, IFNULL(SUM(c.reps), 0) AS docs, IFNULL(SUM(c.tiempo), 0) AS tiempo_c, IF(IFNULL(SUM(c.reps), 0) = 0, 0, IFNULL(SUM(c.tiempo), 0) / IFNULL(SUM(c.reps), 0) / 3600) AS mttrc FROM " + this.servicio.rBD() + ".cat_maquinas a " + (this.grActual == 1 ? "INNER" : "LEFT") + " JOIN (SELECT maquina, linea, COUNT(*) AS reps, SUM(tiemporeparacion + tiempollegada) AS tiempo FROM " + this.servicio.rBD() + ".reportes c WHERE c.contabilizar = 'S' AND c.estatus >= 100  AND c.fecha_reporte >= '" + this.fDesde + "' AND c.fecha_reporte <= '" + this.fHasta + "' " + this.filtroReportes + " GROUP BY maquina, linea) AS c ON a.id = c.maquina LEFT JOIN " + this.servicio.rBD() + ".cat_lineas b ON a.linea = b.id, (SELECT COUNT(*) AS tdias, SUM(IF(dia = 2, 1, 0)) AS lunes, SUM(IF(dia = 3, 1, 0)) AS martes, SUM(IF(dia = 4, 1, 0)) AS miercoles, SUM(IF(dia = 5, 1, 0)) AS jueves, SUM(IF(dia = 6, 1, 0)) AS viernes, SUM(IF(dia = 7, 1, 0)) AS sabado, SUM(IF(dia = 1, 1, 0)) AS domingo FROM " + this.servicio.rBD() + ".dias WHERE  fecha >= '" + this.fDesde + "' AND fecha <= '" + this.fHasta + "' ) AS e " + (this.grActual == 1 ? "" : "WHERE a.id > 0 " + this.filtroMTBF) + " GROUP BY a.linea, b.nombre " + tHaving + " ORDER BY " + ordenDatos + ";";
          ...
          if (this.graficaActual == 2)
          {
            ...
            sentencia = "SELECT a.id, a.nombre, e.tdias, SUM(e.lunes * IFNULL((SELECT lunes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.martes * IFNULL((SELECT martes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.miercoles * IFNULL((SELECT miercoles FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.jueves * IFNULL((SELECT jueves FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.viernes * IFNULL((SELECT viernes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.sabado * IFNULL((SELECT sabado FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.domingo * IFNULL((SELECT domingo FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0)) AS tdisponible, (SUM(e.lunes * IFNULL((SELECT lunes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.martes * IFNULL((SELECT martes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.miercoles * IFNULL((SELECT miercoles FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.jueves * IFNULL((SELECT jueves FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.viernes * IFNULL((SELECT viernes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.sabado * IFNULL((SELECT sabado FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.domingo * IFNULL((SELECT domingo FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0))) / (IFNULL(SUM(c.reps), 0) + 1) / 3600 AS mtbfc, IFNULL(SUM(c.reps), 0) AS docs, IFNULL(SUM(c.tiempo), 0) AS tiempo_c, IF(IFNULL(SUM(c.reps), 0) = 0, 0, IFNULL(SUM(c.tiempo), 0) / IFNULL(SUM(c.reps), 0) / 3600) AS mttrc FROM " + this.servicio.rBD() + ".cat_maquinas a " + (this.grActual == 1 ? "INNER" : "LEFT") + " JOIN (SELECT linea, maquina, COUNT(*) AS reps, SUM(tiemporeparacion + tiempollegada) AS tiempo FROM " + this.servicio.rBD() + ".reportes c WHERE c.contabilizar = 'S' AND c.estatus >= 100  AND c.fecha_reporte >= '" + this.fDesde + "' AND c.fecha_reporte <= '" + this.fHasta + "' " + this.filtroReportes + " GROUP BY linea, maquina) AS c ON a.id = c.maquina, (SELECT COUNT(*) AS tdias, SUM(IF(dia = 2, 1, 0)) AS lunes, SUM(IF(dia = 3, 1, 0)) AS martes, SUM(IF(dia = 4, 1, 0)) AS miercoles, SUM(IF(dia = 5, 1, 0)) AS jueves, SUM(IF(dia = 6, 1, 0)) AS viernes, SUM(IF(dia = 7, 1, 0)) AS sabado, SUM(IF(dia = 1, 1, 0)) AS domingo FROM " + this.servicio.rBD() + ".dias WHERE  fecha >= '" + this.fDesde + "' AND fecha <= '" + this.fHasta + "' ) AS e " + (this.grActual == 1 ? "" : "WHERE a.id > 0 " + this.filtroMTBF) + " GROUP BY a.id, a.nombre " + tHaving + " ORDER BY " + ordenDatos + ";";
          }
          else if (this.graficaActual == 3)
          {
            ordenDatos = " 8 DESC ";
            ...
            sentencia = "SELECT a.id, a.nombre, e.tdias, (e.lunes + e.martes + e.miercoles + e.jueves + e.viernes + e.sabado + e.domingo) AS tdisponible, (e.lunes + e.martes + e.miercoles + e.jueves + e.viernes + e.sabado + e.domingo) / (IFNULL(SUM(c.reps), 0) + 1) / 3600 AS mtbfc, IFNULL(SUM(c.reps), 0) AS docs, IFNULL(SUM(c.tiempo), 0) AS tiempo_c, IF(IFNULL(SUM(c.reps), 0) = 0, 0, IFNULL(SUM(c.tiempo), 0) / IFNULL(SUM(c.reps), 0) / 3600) AS mttrc FROM " + this.servicio.rBD() + ".cat_areas a " + (this.grActual == 1 ? "INNER" : "LEFT") + " JOIN (SELECT AREA, linea, maquina, COUNT(*) AS reps, SUM(tiemporeparacion + tiempollegada) AS tiempo FROM " + this.servicio.rBD() + ".reportes c WHERE c.contabilizar = 'S' AND c.estatus >= 100  AND c.fecha_reporte >= '" + this.fDesde + "' AND c.fecha_reporte <= '" + this.fHasta + "' " + this.filtroReportes + " GROUP BY AREA, linea, maquina) AS c ON a.id = c.AREA, (SELECT COUNT(*) AS tdias, SUM(IF(dia = 2, 1, 0)) * IFNULL((SELECT lunes FROM " + this.servicio.rBD() + ".disponibilidad WHERE estatus = 'A' AND linea = 0 AND maquina = 0 LIMIT 1), 0) AS lunes, SUM(IF(dia = 3, 1, 0)) * IFNULL((SELECT martes FROM " + this.servicio.rBD() + ".disponibilidad WHERE estatus = 'A' AND linea = 0 AND maquina = 0 LIMIT 1), 0) AS martes, SUM(IF(dia = 4, 1, 0)) * IFNULL((SELECT miercoles FROM " + this.servicio.rBD() + ".disponibilidad WHERE estatus = 'A' AND linea = 0 AND maquina = 0 LIMIT 1), 0) AS miercoles, SUM(IF(dia = 5, 1, 0)) * IFNULL((SELECT jueves FROM " + this.servicio.rBD() + ".disponibilidad WHERE estatus = 'A' AND linea = 0 AND maquina = 0 LIMIT 1), 0) AS jueves, SUM(IF(dia = 6, 1, 0)) * IFNULL((SELECT viernes FROM " + this.servicio.rBD() + ".disponibilidad WHERE estatus = 'A' AND linea = 0 AND maquina = 0 LIMIT 1), 0) AS viernes, SUM(IF(dia = 7, 1, 0)) * IFNULL((SELECT sabado FROM " + this.servicio.rBD() + ".disponibilidad WHERE estatus = 'A' AND linea = 0 AND maquina = 0 LIMIT 1), 0) AS sabado, SUM(IF(dia = 1, 1, 0)) * IFNULL((SELECT domingo FROM " + this.servicio.rBD() + ".disponibilidad WHERE estatus = 'A' AND linea = 0 AND maquina = 0 LIMIT 1), 0) AS domingo FROM " + this.servicio.rBD() + ".dias WHERE  fecha >= '" + this.fDesde + "' AND fecha <= '" + this.fHasta + "' ) AS e " + (this.grActual == 1 ? "" : "WHERE a.id > 0 " + this.filtroMTBF_are) + " GROUP BY a.id, a.nombre " + tHaving + " ORDER BY " + ordenDatos + ";";
          }
          else if (this.graficaActual == 4)
          {
            ordenDatos = " 8 DESC ";
            ...
            sentencia = "SELECT a.id, a.nombre, e.tdias, (e.lunes + e.martes + e.miercoles + e.jueves + e.viernes + e.sabado + e.domingo) AS tdisponible, (e.lunes + e.martes + e.miercoles + e.jueves + e.viernes + e.sabado + e.domingo) / (IFNULL(SUM(c.reps), 0) + 1) / 3600 AS mtbfc, IFNULL(SUM(c.reps), 0) AS docs, IFNULL(SUM(c.tiempo), 0) AS tiempo_c, IF(IFNULL(SUM(c.reps), 0) = 0, 0, IFNULL(SUM(c.tiempo), 0) / IFNULL(SUM(c.reps), 0) / 3600) AS mttrc FROM " + this.servicio.rBD() + ".cat_fallas a " + (this.grActual == 1 ? "INNER" : "LEFT") + " JOIN (SELECT falla_ajustada, linea, maquina, COUNT(*) AS reps, SUM(tiemporeparacion + tiempollegada) AS tiempo FROM " + this.servicio.rBD() + ".reportes c WHERE c.contabilizar = 'S' AND c.estatus >= 100  AND c.fecha_reporte >= '" + this.fDesde + "' AND c.fecha_reporte <= '" + this.fHasta + "' " + this.filtroReportes + " GROUP BY falla_ajustada, linea, maquina) AS c ON a.id = c.falla_ajustada, (SELECT COUNT(*) AS tdias, SUM(IF(dia = 2, 1, 0)) * IFNULL((SELECT lunes FROM " + this.servicio.rBD() + ".disponibilidad WHERE estatus = 'A' AND linea = 0 AND maquina = 0 LIMIT 1), 0) AS lunes, SUM(IF(dia = 3, 1, 0)) * IFNULL((SELECT martes FROM " + this.servicio.rBD() + ".disponibilidad WHERE estatus = 'A' AND linea = 0 AND maquina = 0 LIMIT 1), 0) AS martes, SUM(IF(dia = 4, 1, 0)) * IFNULL((SELECT miercoles FROM " + this.servicio.rBD() + ".disponibilidad WHERE estatus = 'A' AND linea = 0 AND maquina = 0 LIMIT 1), 0) AS miercoles, SUM(IF(dia = 5, 1, 0)) * IFNULL((SELECT jueves FROM " + this.servicio.rBD() + ".disponibilidad WHERE estatus = 'A' AND linea = 0 AND maquina = 0 LIMIT 1), 0) AS jueves, SUM(IF(dia = 6, 1, 0)) * IFNULL((SELECT viernes FROM " + this.servicio.rBD() + ".disponibilidad WHERE estatus = 'A' AND linea = 0 AND maquina = 0 LIMIT 1), 0) AS viernes, SUM(IF(dia = 7, 1, 0)) * IFNULL((SELECT sabado FROM " + this.servicio.rBD() + ".disponibilidad WHERE estatus = 'A' AND linea = 0 AND maquina = 0 LIMIT 1), 0) AS sabado, SUM(IF(dia = 1, 1, 0)) * IFNULL((SELECT domingo FROM " + this.servicio.rBD() + ".disponibilidad WHERE estatus = 'A' AND linea = 0 AND maquina = 0 LIMIT 1), 0) AS domingo FROM " + this.servicio.rBD() + ".dias WHERE  fecha >= '" + this.fDesde + "' AND fecha <= '" + this.fHasta + "' ) AS e " + (this.grActual == 1 ? "" : "WHERE a.id > 0 " + this.filtroMTBF_fal) + " GROUP BY a.id, a.nombre " + tHaving + " ORDER BY " + ordenDatos + ";";
          }
          else if (this.graficaActual == 5)
          {
            let ordenDatos = " 9 DESC";
            ...
            sentencia = "SELECT a.tipo, IFNULL(b.nombre, '" + this.servicio.rTraduccion()[8] + "') AS nombre, COUNT(*), e.tdias, SUM(e.lunes * IFNULL((SELECT lunes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.martes * IFNULL((SELECT martes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.miercoles * IFNULL((SELECT miercoles FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.jueves * IFNULL((SELECT jueves FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.viernes * IFNULL((SELECT viernes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.sabado * IFNULL((SELECT sabado FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.domingo * IFNULL((SELECT domingo FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0)) AS tdisponible, (SUM(e.lunes * IFNULL((SELECT lunes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.martes * IFNULL((SELECT martes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.miercoles * IFNULL((SELECT miercoles FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.jueves * IFNULL((SELECT jueves FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.viernes * IFNULL((SELECT viernes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.sabado * IFNULL((SELECT sabado FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.domingo * IFNULL((SELECT domingo FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0))) / (IFNULL(SUM(c.reps), 0) + 1) / 3600 AS mtbfc, IFNULL(SUM(c.reps), 0) AS docs, IFNULL(SUM(c.tiempo), 0) AS tiempo_c, IF(IFNULL(SUM(c.reps), 0) = 0, 0, IFNULL(SUM(c.tiempo), 0) / IFNULL(SUM(c.reps), 0) / 3600) AS mttrc FROM " + this.servicio.rBD() + ".cat_maquinas a " + (this.grActual == 1 ? "INNER" : "LEFT") + " JOIN (SELECT maquina, linea, COUNT(*) AS reps, SUM(tiemporeparacion + tiempollegada) AS tiempo FROM " + this.servicio.rBD() + ".reportes c WHERE c.contabilizar = 'S' AND c.estatus >= 100  AND c.fecha_reporte >= '" + this.fDesde + "' AND c.fecha_reporte <= '" + this.fHasta + "' " + this.filtroReportes + " GROUP BY maquina, linea) AS c ON a.id = c.maquina LEFT JOIN " + this.servicio.rBD() + ".cat_generales b ON a.tipo = b.id AND b.tabla = 50, (SELECT COUNT(*) AS tdias, SUM(IF(dia = 2, 1, 0)) AS lunes, SUM(IF(dia = 3, 1, 0)) AS martes, SUM(IF(dia = 4, 1, 0)) AS miercoles, SUM(IF(dia = 5, 1, 0)) AS jueves, SUM(IF(dia = 6, 1, 0)) AS viernes, SUM(IF(dia = 7, 1, 0)) AS sabado, SUM(IF(dia = 1, 1, 0)) AS domingo FROM " + this.servicio.rBD() + ".dias WHERE  fecha >= '" + this.fDesde + "' AND fecha <= '" + this.fHasta + "' ) AS e " + (this.grActual == 1 ? "" : "WHERE a.id > 0 " + this.filtroMTBF) + " GROUP BY a.tipo, nombre " + tHaving + " ORDER BY " + ordenDatos + ";";
          }
          else if (this.graficaActual == 6)
          {
            let ordenDatos = " 9 DESC";
            ...
            sentencia = "SELECT a.agrupador_1, IFNULL(b.nombre, '" + this.servicio.rTraduccion()[8] + "') AS nombre, COUNT(*), e.tdias, SUM(e.lunes * IFNULL((SELECT lunes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.martes * IFNULL((SELECT martes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.miercoles * IFNULL((SELECT miercoles FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.jueves * IFNULL((SELECT jueves FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.viernes * IFNULL((SELECT viernes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.sabado * IFNULL((SELECT sabado FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.domingo * IFNULL((SELECT domingo FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0)) AS tdisponible, (SUM(e.lunes * IFNULL((SELECT lunes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.martes * IFNULL((SELECT martes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.miercoles * IFNULL((SELECT miercoles FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.jueves * IFNULL((SELECT jueves FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.viernes * IFNULL((SELECT viernes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.sabado * IFNULL((SELECT sabado FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.domingo * IFNULL((SELECT domingo FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0))) / (IFNULL(SUM(c.reps), 0) + 1) / 3600 AS mtbfc, IFNULL(SUM(c.reps), 0) AS docs, IFNULL(SUM(c.tiempo), 0) AS tiempo_c, IF(IFNULL(SUM(c.reps), 0) = 0, 0, IFNULL(SUM(c.tiempo), 0) / IFNULL(SUM(c.reps), 0) / 3600) AS mttrc FROM " + this.servicio.rBD() + ".cat_maquinas a " + (this.grActual == 1 ? "INNER" : "LEFT") + " JOIN (SELECT maquina, linea, COUNT(*) AS reps, SUM(tiemporeparacion + tiempollegada) AS tiempo FROM " + this.servicio.rBD() + ".reportes c WHERE c.contabilizar = 'S' AND c.estatus >= 100  AND c.fecha_reporte >= '" + this.fDesde + "' AND c.fecha_reporte <= '" + this.fHasta + "' " + this.filtroReportes + " GROUP BY maquina, linea) AS c ON a.id = c.maquina LEFT JOIN " + this.servicio.rBD() + ".cat_generales b ON a.agrupador_1 = b.id AND b.tabla = 20, (SELECT COUNT(*) AS tdias, SUM(IF(dia = 2, 1, 0)) AS lunes, SUM(IF(dia = 3, 1, 0)) AS martes, SUM(IF(dia = 4, 1, 0)) AS miercoles, SUM(IF(dia = 5, 1, 0)) AS jueves, SUM(IF(dia = 6, 1, 0)) AS viernes, SUM(IF(dia = 7, 1, 0)) AS sabado, SUM(IF(dia = 1, 1, 0)) AS domingo FROM " + this.servicio.rBD() + ".dias WHERE  fecha >= '" + this.fDesde + "' AND fecha <= '" + this.fHasta + "' ) AS e " + (this.grActual == 1 ? "" : "WHERE a.id > 0 " + this.filtroMTBF) + " GROUP BY a.agrupador_1, nombre " + tHaving + " ORDER BY " + ordenDatos + ";";
          }
          else if (this.graficaActual == 7)
          {
            let ordenDatos = " 9 DESC";
            ...
            sentencia = "SELECT a.agrupador_2, IFNULL(b.nombre, '" + this.servicio.rTraduccion()[8] + "') AS nombre, COUNT(*), e.tdias, SUM(e.lunes * IFNULL((SELECT lunes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.martes * IFNULL((SELECT martes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.miercoles * IFNULL((SELECT miercoles FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.jueves * IFNULL((SELECT jueves FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.viernes * IFNULL((SELECT viernes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.sabado * IFNULL((SELECT sabado FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.domingo * IFNULL((SELECT domingo FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0)) AS tdisponible, (SUM(e.lunes * IFNULL((SELECT lunes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.martes * IFNULL((SELECT martes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.miercoles * IFNULL((SELECT miercoles FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.jueves * IFNULL((SELECT jueves FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.viernes * IFNULL((SELECT viernes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.sabado * IFNULL((SELECT sabado FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.domingo * IFNULL((SELECT domingo FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0))) / (IFNULL(SUM(c.reps), 0) + 1) / 3600 AS mtbfc, IFNULL(SUM(c.reps), 0) AS docs, IFNULL(SUM(c.tiempo), 0) AS tiempo_c, IF(IFNULL(SUM(c.reps), 0) = 0, 0, IFNULL(SUM(c.tiempo), 0) / IFNULL(SUM(c.reps), 0) / 3600) AS mttrc FROM " + this.servicio.rBD() + ".cat_maquinas a " + (this.grActual == 1 ? "INNER" : "LEFT") + " JOIN (SELECT maquina, linea, COUNT(*) AS reps, SUM(tiemporeparacion + tiempollegada) AS tiempo FROM " + this.servicio.rBD() + ".reportes c WHERE c.contabilizar = 'S' AND c.estatus >= 100  AND c.fecha_reporte >= '" + this.fDesde + "' AND c.fecha_reporte <= '" + this.fHasta + "' " + this.filtroReportes + " GROUP BY maquina, linea) AS c ON a.id = c.maquina LEFT JOIN " + this.servicio.rBD() + ".cat_generales b ON a.agrupador_2 = b.id AND b.tabla = 25, (SELECT COUNT(*) AS tdias, SUM(IF(dia = 2, 1, 0)) AS lunes, SUM(IF(dia = 3, 1, 0)) AS martes, SUM(IF(dia = 4, 1, 0)) AS miercoles, SUM(IF(dia = 5, 1, 0)) AS jueves, SUM(IF(dia = 6, 1, 0)) AS viernes, SUM(IF(dia = 7, 1, 0)) AS sabado, SUM(IF(dia = 1, 1, 0)) AS domingo FROM " + this.servicio.rBD() + ".dias WHERE  fecha >= '" + this.fDesde + "' AND fecha <= '" + this.fHasta + "' ) AS e " + (this.grActual == 1 ? "" : "WHERE a.id > 0 " + this.filtroMTBF) + " GROUP BY a.agrupador_2, nombre " + tHaving + " ORDER BY " + ordenDatos + ";";
          }
          else if (this.graficaActual == 8)
          {
            let ordenDatos = " 9 DESC";
            ...
            sentencia = "SELECT a.agrupador_1, IFNULL(b.nombre, '" + this.servicio.rTraduccion()[8] + "') AS nombre, COUNT(*), e.tdias, SUM(e.lunes * IFNULL((SELECT lunes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.martes * IFNULL((SELECT martes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.miercoles * IFNULL((SELECT miercoles FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.jueves * IFNULL((SELECT jueves FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.viernes * IFNULL((SELECT viernes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.sabado * IFNULL((SELECT sabado FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.domingo * IFNULL((SELECT domingo FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0)) AS tdisponible, (SUM(e.lunes * IFNULL((SELECT lunes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.martes * IFNULL((SELECT martes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.miercoles * IFNULL((SELECT miercoles FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.jueves * IFNULL((SELECT jueves FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.viernes * IFNULL((SELECT viernes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.sabado * IFNULL((SELECT sabado FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.domingo * IFNULL((SELECT domingo FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0))) / (IFNULL(SUM(c.reps), 0) + 1) / 3600 AS mtbfc, IFNULL(SUM(c.reps), 0) AS docs, IFNULL(SUM(c.tiempo), 0) AS tiempo_c, IF(IFNULL(SUM(c.reps), 0) = 0, 0, IFNULL(SUM(c.tiempo), 0) / IFNULL(SUM(c.reps), 0) / 3600) AS mttrc FROM " + this.servicio.rBD() + ".cat_fallas a " + (this.grActual == 1 ? "INNER" : "LEFT") + " JOIN (SELECT falla_ajustada, maquina, linea, COUNT(*) AS reps, SUM(tiemporeparacion + tiempollegada) AS tiempo FROM " + this.servicio.rBD() + ".reportes c WHERE c.contabilizar = 'S' AND c.estatus >= 100  AND c.fecha_reporte >= '" + this.fDesde + "' AND c.fecha_reporte <= '" + this.fHasta + "' " + this.filtroReportes + " GROUP BY falla_ajustada, maquina, linea) AS c ON a.id = c.falla_ajustada LEFT JOIN " + this.servicio.rBD() + ".cat_generales b ON a.agrupador_1 = b.id AND b.tabla = 40, (SELECT COUNT(*) AS tdias, SUM(IF(dia = 2, 1, 0)) AS lunes, SUM(IF(dia = 3, 1, 0)) AS martes, SUM(IF(dia = 4, 1, 0)) AS miercoles, SUM(IF(dia = 5, 1, 0)) AS jueves, SUM(IF(dia = 6, 1, 0)) AS viernes, SUM(IF(dia = 7, 1, 0)) AS sabado, SUM(IF(dia = 1, 1, 0)) AS domingo FROM " + this.servicio.rBD() + ".dias WHERE  fecha >= '" + this.fDesde + "' AND fecha <= '" + this.fHasta + "' ) AS e " + (this.grActual == 1 ? "" : "WHERE a.id > 0 " + this.filtroMTBF_fal) + " GROUP BY a.agrupador_1, nombre " + tHaving + " ORDER BY " + ordenDatos + ";";
          }
          else if (this.graficaActual == 9)
          {
            let ordenDatos = " 9 DESC";
            ...
            sentencia = "SELECT a.agrupador_2, IFNULL(b.nombre, '" + this.servicio.rTraduccion()[8] + "') AS nombre, COUNT(*), e.tdias, SUM(e.lunes * IFNULL((SELECT lunes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.martes * IFNULL((SELECT martes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.miercoles * IFNULL((SELECT miercoles FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.jueves * IFNULL((SELECT jueves FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.viernes * IFNULL((SELECT viernes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.sabado * IFNULL((SELECT sabado FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.domingo * IFNULL((SELECT domingo FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0)) AS tdisponible, (SUM(e.lunes * IFNULL((SELECT lunes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.martes * IFNULL((SELECT martes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.miercoles * IFNULL((SELECT miercoles FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.jueves * IFNULL((SELECT jueves FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.viernes * IFNULL((SELECT viernes FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.sabado * IFNULL((SELECT sabado FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0) + e.domingo * IFNULL((SELECT domingo FROM " + this.servicio.rBD() + ".disponibilidad WHERE (estatus = 'A') AND ((c.linea = linea) OR (c.maquina = maquina) OR (maquina = 0 AND linea = 0)) ORDER BY maquina DESC, linea DESC LIMIT 1), 0))) / (IFNULL(SUM(c.reps), 0) + 1) / 3600 AS mtbfc, IFNULL(SUM(c.reps), 0) AS docs, IFNULL(SUM(c.tiempo), 0) AS tiempo_c, IF(IFNULL(SUM(c.reps), 0) = 0, 0, IFNULL(SUM(c.tiempo), 0) / IFNULL(SUM(c.reps), 0) / 3600) AS mttrc FROM " + this.servicio.rBD() + ".cat_fallas a " + (this.grActual == 1 ? "INNER" : "LEFT") + " JOIN (SELECT falla_ajustada, maquina, linea, COUNT(*) AS reps, SUM(tiemporeparacion + tiempollegada) AS tiempo FROM " + this.servicio.rBD() + ".reportes c WHERE c.contabilizar = 'S' AND c.estatus >= 100  AND c.fecha_reporte >= '" + this.fDesde + "' AND c.fecha_reporte <= '" + this.fHasta + "' " + this.filtroReportes + " GROUP BY falla_ajustada, maquina, linea) AS c ON a.id = c.falla_ajustada LEFT JOIN " + this.servicio.rBD() + ".cat_generales b ON a.agrupador_2 = b.id AND b.tabla = 45, (SELECT COUNT(*) AS tdias, SUM(IF(dia = 2, 1, 0)) AS lunes, SUM(IF(dia = 3, 1, 0)) AS martes, SUM(IF(dia = 4, 1, 0)) AS miercoles, SUM(IF(dia = 5, 1, 0)) AS jueves, SUM(IF(dia = 6, 1, 0)) AS viernes, SUM(IF(dia = 7, 1, 0)) AS sabado, SUM(IF(dia = 1, 1, 0)) AS domingo FROM " + this.servicio.rBD() + ".dias WHERE  fecha >= '" + this.fDesde + "' AND fecha <= '" + this.fHasta + "' ) AS e " + (this.grActual == 1 ? "" : "WHERE a.id > 0 " + this.filtroMTBF_fal) + " GROUP BY a.agrupador_2, nombre " + tHaving + " ORDER BY " + ordenDatos + ";";
          }
          else if (this.graficaActual == 10)
          {
            ...
            sentencia = "SELECT a.fecha AS nombre, IFNULL(IF(a.dia = 1, g.domingo, IF(a.dia = 2, g.lunes, IF(a.dia = 3, g.martes, IF(a.dia = 4, g.miercoles, IF(a.dia = 5, g.jueves, IF(a.dia = 6, g.viernes, g.sabado)))))), 0) AS tdisponible, IFNULL(IF(a.dia = 1, g.domingo, IF(a.dia = 2, g.lunes, IF(a.dia = 3, g.martes, IF(a.dia = 4, g.miercoles, IF(a.dia = 5, g.jueves, IF(a.dia = 6, g.viernes, g.sabado)))))), 0) / (IFNULL(SUM(c.reps), 0) + 1) / 3600 AS mtbfc, IFNULL(SUM(c.reps), 0) AS docs, IFNULL(SUM(c.tiempo), 0) AS tiempo_c, IF(IFNULL(SUM(c.reps), 0) = 0, 0, IFNULL(SUM(c.tiempo), 0) / IFNULL(SUM(c.reps), 0) / 3600) AS mttrc FROM " + this.servicio.rBD() + ".dias a " + (this.grActual == 1 ? "INNER" : "LEFT") + " JOIN (SELECT fecha_reporte, COUNT(*) AS reps, SUM(tiemporeparacion + tiempollegada) AS tiempo FROM " + this.servicio.rBD() + ".reportes c WHERE c.contabilizar = 'S' AND c.estatus >= 100  AND c.fecha_reporte >= '" + this.fDesde + "' AND c.fecha_reporte <= '" + this.fHasta + "' " + this.filtroReportes + " GROUP BY fecha_reporte) AS c ON a.fecha = c.fecha_reporte, (SELECT * FROM " + this.servicio.rBD() + ".disponibilidad WHERE estatus = 'A' AND maquina = 0 AND linea = 0 LIMIT 1) AS g WHERE  fecha >= '" + this.fDesde + "' AND fecha <= '" + this.fHasta + "' GROUP BY nombre " + tHaving + " ORDER BY " + ordenDatos + ";";
          }
          else if (this.graficaActual == 11)
          {
          ...
          else if (this.graficaActual == 12)
          {
            ...
            sentencia = "SELECT CONCAT(YEAR(a.fecha), '/', MONTH(a.fecha)) AS nombre, COUNT(*), SUM(IFNULL(IF(a.dia = 1, g.domingo, IF(a.dia = 2, g.lunes, IF(a.dia = 3, g.martes, IF(a.dia = 4, g.miercoles, IF(a.dia = 5, g.jueves, IF(a.dia = 6, g.viernes, g.sabado)))))), 0)) AS tdisponible, SUM(IFNULL(IF(a.dia = 1, g.domingo, IF(a.dia = 2, g.lunes, IF(a.dia = 3, g.martes, IF(a.dia = 4, g.miercoles, IF(a.dia = 5, g.jueves, IF(a.dia = 6, g.viernes, g.sabado)))))), 0)) / (IFNULL(SUM(c.reps), 0) + 1) / 3600 AS mtbfc, IFNULL(SUM(c.reps), 0) AS docs, IFNULL(SUM(c.tiempo), 0) AS tiempo_c, IF(IFNULL(SUM(c.reps), 0) = 0, 0, IFNULL(SUM(c.tiempo), 0) / IFNULL(SUM(c.reps), 0) / 3600) AS mttrc FROM " + this.servicio.rBD() + ".dias a " + (this.grActual == 1 ? "INNER" : "LEFT") + " JOIN (SELECT fecha_reporte, COUNT(*) AS reps, SUM(tiemporeparacion + tiempollegada) AS tiempo FROM " + this.servicio.rBD() + ".reportes c WHERE c.contabilizar = 'S' AND c.estatus >= 100  AND c.fecha_reporte >= '" + this.fDesde + "' AND c.fecha_reporte <= '" + this.fHasta + "' " + this.filtroReportes + " GROUP BY fecha_reporte) AS c ON a.fecha = c.fecha_reporte, (SELECT * FROM " + this.servicio.rBD() + ".disponibilidad WHERE estatus = 'A' AND maquina = 0 AND linea = 0 LIMIT 1) AS g WHERE  fecha >= '" + this.fDesde + "' AND fecha <= '" + this.fHasta + "' GROUP BY nombre " + tHaving + " ORDER BY " + ordenDatos + ";";
          }
          else if (this.graficaActual == 13)
          {
            ordenDatos = " 8 DESC ";
            ...
            sentencia = "SELECT a.id, a.nombre, e.tdias, (e.lunes + e.martes + e.miercoles + e.jueves + e.viernes + e.sabado + e.domingo) AS tdisponible, (e.lunes + e.martes + e.miercoles + e.jueves + e.viernes + e.sabado + e.domingo) / (IFNULL(SUM(c.reps), 0) + 1) / 3600 AS mtbfc, IFNULL(SUM(c.reps), 0) AS docs, IFNULL(SUM(c.tiempo), 0) AS tiempo_c, IF(IFNULL(SUM(c.reps), 0) = 0, 0, IFNULL(SUM(c.tiempo), 0) / IFNULL(SUM(c.reps), 0) / 3600) AS mttrc FROM " + this.servicio.rBD() + ".cat_usuarios a " + (this.grActual == 1 ? "INNER" : "LEFT") + " JOIN (SELECT tecnicoatend, maquina, COUNT(*) AS reps, SUM(tiemporeparacion + tiempollegada) AS tiempo FROM " + this.servicio.rBD() + ".reportes c WHERE c.contabilizar = 'S' AND c.estatus >= 100  AND c.fecha_reporte >= '" + this.fDesde + "' AND c.fecha_reporte <= '" + this.fHasta + "' " + this.filtroReportes + " GROUP BY tecnicoatend, maquina) AS c ON a.id = c.tecnicoatend, (SELECT COUNT(*) AS tdias, SUM(IF(dia = 2, 1, 0)) * IFNULL((SELECT lunes FROM " + this.servicio.rBD() + ".disponibilidad WHERE estatus = 'A' AND linea = 0 AND maquina = 0 LIMIT 1), 0) AS lunes, SUM(IF(dia = 3, 1, 0)) * IFNULL((SELECT martes FROM " + this.servicio.rBD() + ".disponibilidad WHERE estatus = 'A' AND linea = 0 AND maquina = 0 LIMIT 1), 0) AS martes, SUM(IF(dia = 4, 1, 0)) * IFNULL((SELECT miercoles FROM " + this.servicio.rBD() + ".disponibilidad WHERE estatus = 'A' AND linea = 0 AND maquina = 0 LIMIT 1), 0) AS miercoles, SUM(IF(dia = 5, 1, 0)) * IFNULL((SELECT jueves FROM " + this.servicio.rBD() + ".disponibilidad WHERE estatus = 'A' AND linea = 0 AND maquina = 0 LIMIT 1), 0) AS jueves, SUM(IF(dia = 6, 1, 0)) * IFNULL((SELECT viernes FROM " + this.servicio.rBD() + ".disponibilidad WHERE estatus = 'A' AND linea = 0 AND maquina = 0 LIMIT 1), 0) AS viernes, SUM(IF(dia = 7, 1, 0)) * IFNULL((SELECT sabado FROM " + this.servicio.rBD() + ".disponibilidad WHERE estatus = 'A' AND linea = 0 AND maquina = 0 LIMIT 1), 0) AS sabado, SUM(IF(dia = 1, 1, 0)) * IFNULL((SELECT domingo FROM " + this.servicio.rBD() + ".disponibilidad WHERE estatus = 'A' AND linea = 0 AND maquina = 0 LIMIT 1), 0) AS domingo FROM " + this.servicio.rBD() + ".dias WHERE  fecha >= '" + this.fDesde + "' AND fecha <= '" + this.fHasta + "' ) AS e " + (this.grActual == 1 ? "" : "WHERE a.id > 0 " + this.filtroMTBF_tec) + " GROUP BY a.id, a.nombre " + tHaving + " ORDER BY " + ordenDatos + ";";
          }
        }
        else if (this.grActual == 3)
        {
        ...
        else if (this.grActual == 7)
        {
          ...
          if (this.graficaActual <= 3)
          {
            ...
            sentencia = "SELECT d.nombre, " + (this.graficaActual == 5 ? "d.referencia, " : "") + tablaID + " AS id, COUNT(*) AS docs, SUM(IF(c.evaluacion = 'N', 1, 0)) AS nega, SUM(IF(c.evaluacion = 'P', 1, 0)) AS posi, IF(COUNT(*) > 0, SUM(IF(c.evaluacion = 'P', 1, 0)) / COUNT(*) * 100, 0) AS positivos, SUM(c.tiempo) / 3600 AS tiempo, 0 AS porcentaje FROM " + this.servicio.rBD() + ".rkanban_cab c INNER JOIN " + this.servicio.rBD() + tablaUnion + " = d.id WHERE c.estado >= 50 AND c.inicio >= '" + this.fDesde + " 00:00:00' AND c.inicio <= '" + this.fHasta + " 23:59:59' " + this.filtroKanban + " GROUP BY d.nombre " + tHaving + " ORDER BY " + ordenDatos
          }
          else 
          {
            let ordenDatos = "5"; 
            ...
            if (this.graficaActual == 4)
            {
              sentencia = "SELECT DATE_FORMAT(c.inicio, '%d/%m/%Y') AS nombre, COUNT(*) AS docs, SUM(IF(c.evaluacion = 'N', 1, 0)) AS nega, SUM(IF(c.evaluacion = 'P', 1, 0)) AS posi, IF(COUNT(*) > 0, SUM(IF(c.evaluacion = 'P', 1, 0)) / COUNT(*) * 100, 0) AS positivos, SUM(c.tiempo) / 3600 AS tiempo, 0 AS porcentaje FROM " + this.servicio.rBD() + ".rkanban_cab c WHERE c.estado >= 50 AND c.inicio >= '" + this.fDesde + " 00:00:00' AND c.inicio <= '" + this.fHasta + " 23:59:59' " + this.filtroKanban + " GROUP BY DATE_FORMAT(c.inicio, '%d/%m/%Y') " + tHaving + " ORDER BY " + ordenDatos
            }
            else if (this.graficaActual == 5)
            {
              let ordenDatos = "6"; 
              ...
              sentencia = "SELECT CONCAT(YEAR(c.inicio), '/', WEEK(c.inicio))  AS nombre, STR_TO_DATE(CONCAT(DATE_FORMAT(c.inicio,'%x/%v'), ' Monday'), '%x/%v %W') AS referencia, COUNT(*) AS docs, SUM(IF(c.evaluacion = 'N', 1, 0)) AS nega, SUM(IF(c.evaluacion = 'P', 1, 0)) AS posi, IF(COUNT(*) > 0, SUM(IF(c.evaluacion = 'P', 1, 0)) / COUNT(*) * 100, 0) AS positivos, SUM(c.tiempo) / 3600 AS tiempo, 0 AS porcentaje FROM " + this.servicio.rBD() + ".rkanban_cab c WHERE c.estado >= 50 AND c.inicio >= '" + this.fDesde + " 00:00:00' AND c.inicio <= '" + this.fHasta + " 23:59:59' " + this.filtroKanban + " GROUP BY 1 " + tHaving + " ORDER BY " + ordenDatos
            }
            else if (this.graficaActual == 6)
            {
              sentencia = "SELECT CONCAT(YEAR(c.inicio), '/', MONTH(c.inicio)) AS nombre, COUNT(*) AS docs, SUM(IF(c.evaluacion = 'N', 1, 0)) AS nega, SUM(IF(c.evaluacion = 'P', 1, 0)) AS posi, IF(COUNT(*) > 0, SUM(IF(c.evaluacion = 'P', 1, 0)) / COUNT(*) * 100, 0) AS positivos, SUM(c.tiempo) / 3600 AS tiempo, 0 AS porcentaje FROM " + this.servicio.rBD() + ".rkanban_cab c WHERE c.estado >= 50 AND c.inicio >= '" + this.fDesde + " 00:00:00' AND c.inicio <= '" + this.fHasta + " 23:59:59' " + this.filtroKanban + " GROUP BY 1 " + tHaving + " ORDER BY " + ordenDatos
            }
          }
        }
        else if (this.grActual == 8)
        {
          ...
          if (this.graficaActual <= 5)
          {
            ...
            sentencia = "SELECT d.nombre, " + (this.graficaActual == 5 ? "d.referencia, " : "") + tablaID + " AS id, COUNT(*) AS docs, SUM(IF(c.evaluacion = 'N', 1, 0)) AS nega, SUM(IF(c.evaluacion = 'P', 1, 0)) AS posi, IF(COUNT(*) > 0, SUM(IF(c.evaluacion = 'P', 1, 0)) / COUNT(*) * 100, 0) AS positivos, SUM(c.tiempo) / 3600 AS tiempo, 0 AS porcentaje FROM " + this.servicio.rBD() + ".kanban_solicitudes c INNER JOIN " + this.servicio.rBD() + tablaUnion + " = d.id WHERE c.contabilizar = 'S' AND c.estado >= 50 AND c.fecha_reporte >= '" + this.fDesde + "' AND c.fecha_reporte <= '" + this.fHasta + "' " + this.filtroKanban + " GROUP BY d.nombre " + tHaving + " ORDER BY " + ordenDatos
          }
          else 
          {
            let ordenDatos = "5"; 
            ...
            if (this.graficaActual == 6)
            {
              sentencia = "SELECT c.fecha_reporte AS nombre, COUNT(*) AS docs, SUM(IF(c.evaluacion = 'N', 1, 0)) AS nega, SUM(IF(c.evaluacion = 'P', 1, 0)) AS posi, IF(COUNT(*) > 0, SUM(IF(c.evaluacion = 'P', 1, 0)) / COUNT(*) * 100, 0) AS positivos, SUM(c.tiempo) / 3600 AS tiempo, 0 AS porcentaje FROM " + this.servicio.rBD() + ".kanban_solicitudes c WHERE c.contabilizar = 'S' AND c.estado >= 50 AND c.fecha_reporte >= '" + this.fDesde + "' AND c.fecha_reporte <= '" + this.fHasta + "' " + this.filtroKanban + " GROUP BY 1 " + tHaving + " ORDER BY " + ordenDatos
            }
            else if (this.graficaActual == 7)
            {
              let ordenDatos = "6"; 
              ...
              sentencia = "SELECT CONCAT(YEAR(c.fecha_reporte), '/', WEEK(c.fecha_reporte))  AS nombre, STR_TO_DATE(CONCAT(DATE_FORMAT(c.fecha_reporte,'%x/%v'), ' Monday'), '%x/%v %W') AS referencia, COUNT(*) AS docs, SUM(IF(c.evaluacion = 'N', 1, 0)) AS nega, SUM(IF(c.evaluacion = 'P', 1, 0)) AS posi, IF(COUNT(*) > 0, SUM(IF(c.evaluacion = 'P', 1, 0)) / COUNT(*) * 100, 0) AS positivos, SUM(c.tiempo) / 3600 AS tiempo, 0 AS porcentaje FROM " + this.servicio.rBD() + ".kanban_solicitudes c WHERE c.contabilizar = 'S' AND c.estado >= 50 AND c.fecha_reporte >= '" + this.fDesde + "' AND c.fecha_reporte <= '" + this.fHasta + "' " + this.filtroKanban + " GROUP BY 1 " + tHaving + " ORDER BY " + ordenDatos
            }
            else if (this.graficaActual == 8)
            {
              sentencia = "SELECT CONCAT(YEAR(c.fecha_reporte), '/', MONTH(c.fecha_reporte)) AS nombre, COUNT(*) AS docs, SUM(IF(c.evaluacion = 'N', 1, 0)) AS nega, SUM(IF(c.evaluacion = 'P', 1, 0)) AS posi, IF(COUNT(*) > 0, SUM(IF(c.evaluacion = 'P', 1, 0)) / COUNT(*) * 100, 0) AS positivos, SUM(c.tiempo) / 3600 AS tiempo, 0 AS porcentaje FROM " + this.servicio.rBD() + ".kanban_solicitudes c WHERE c.contabilizar = 'S' AND c.estado >= 50 AND c.fecha_reporte >= '" + this.fDesde + "' AND c.fecha_reporte <= '" + this.fHasta + "' " + this.filtroKanban + " GROUP BY 1 " + tHaving + " ORDER BY " + ordenDatos
            }
          }
        }
...
listarConsultas()
  ...
  listarProcesos()
  {
    let sentencia = "SELECT a.id, a.nombre, IF(ISNULL(b.valor), 0, 1) AS seleccionado FROM " + this.servicio.rBD() + ".cat_procesos a LEFT JOIN " + this.servicio.rBD() + ".consultas_det b ON b.valor = a.id AND b.tabla = 90 AND b.consulta = " + this.consultaTemp + " WHERE  a.kanban = 'S' ORDER BY seleccionado DESC, a.nombre;"
    this.procesos = [];
    let campos = {accion: 100, sentencia: sentencia};  
    this.servicio.consultasBD(campos).subscribe( resp =>
    {
  ...
  listarLotes()
  {
    let sentencia = "SELECT a.id, IF(ISNULL(c.nombre), a.numero, CONCAT(a.numero, ' / ', c.nombre)) AS nombre, IF(ISNULL(b.valor), 0, 1) AS seleccionado FROM " + this.servicio.rBD() + ".lotes a LEFT JOIN " + this.servicio.rBD() + ".cat_partes c ON a.parte = c.id LEFT JOIN " + this.servicio.rBD() + ".consultas_det b ON b.valor = a.id AND b.tabla = 80 AND b.consulta = " + this.consultaTemp + " WHERE a.estatus = 'A' AND a.creacion >= DATE_ADD(NOW(), INTERVAL - 12 MONTH) ORDER BY seleccionado DESC, nombre;"
    this.lotes = [];
    let campos = {accion: 100, sentencia: sentencia};  
    this.servicio.consultasBD(campos).subscribe( resp =>
    {
  ...
  listarResponsables()
  {
    let sentencia = "SELECT a.id, a.nombre, IF(ISNULL(b.valor), 0, 1) AS seleccionado FROM " + this.servicio.rBD() + ".cat_generales a LEFT JOIN " + this.servicio.rBD() + ".consultas_det b ON b.valor = a.id AND b.tabla = 30 AND b.consulta = " + this.consultaTemp + " WHERE a.tabla = " + (this.grActual == 5 ? "145" : "140") + " ORDER BY seleccionado DESC, a.nombre;"
    this.responsables = [];
    let campos = {accion: 100, sentencia: sentencia};  
    this.servicio.consultasBD(campos).subscribe( resp =>
    {
  ...
  listarTecnicos()
  {
    ...
    let sentencia = "SELECT a.id, a.nombre, IF(ISNULL(b.valor), 0, 1) AS seleccionado FROM " + this.servicio.rBD() + ".cat_usuarios a LEFT JOIN " + this.servicio.rBD() + ".consultas_det b ON b.valor = a.id AND b.tabla = 50 AND b.consulta = " + this.consultaTemp + " WHERE (a.rol = 'A'" + cadAdicional + ") ORDER BY seleccionado DESC, a.nombre;"
    this.tecnicos = [];
    let campos = {accion: 100, sentencia: sentencia};  
    this.servicio.consultasBD(campos).subscribe( resp =>
    {
