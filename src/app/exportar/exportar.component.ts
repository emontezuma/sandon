      ...
      else if (this.reporteSel==8 && resp[0].listado01 == "F")
      {
        ...
        respuesta.afterClosed().subscribe(result => 
        {
          if (result)
          {
            if (result.accion == 1) 
            {
              this.sentenciaR = "SELECT '" + this.servicio.rTraduccion()[1349] + "', '" + this.servicio.rTraduccion()[3516] + "', '" + this.servicio.rTraduccion()[3517] + "', '" + this.servicio.rTraduccion()[2162] + "', '" + this.servicio.rTraduccion()[1834] + "', '" + this.servicio.rTraduccion()[1835] + "', '" + this.servicio.rTraduccion()[3519] + "', '" + this.servicio.rTraduccion()[3518] + "', '" + this.servicio.rTraduccion()[1826] + "', '" + this.servicio.rTraduccion()[3520] + "', '" + this.servicio.rTraduccion()[3515] + "', '" + this.servicio.rTraduccion()[748] + "', '" + this.servicio.rTraduccion()[2131] + "', '" + this.servicio.rTraduccion()[2101] + "', '" + this.servicio.rTraduccion()[2322] + "', '" + this.servicio.rTraduccion()[2263] + "', '" + this.servicio.rTraduccion()[3521] + "', '" + this.servicio.rTraduccion()[1884] + "', '" + this.servicio.rTraduccion()[3522] + "', '" + this.servicio.rTraduccion()[1888] + "' UNION (SELECT c.numero, a.lote, a.orden, a.secuencia, a.proceso_desde, a.proceso_hasta, a.tiempo_setup, a.tiempo_espera, a.tiempo_proceso, IF(a.ultima = 'S', '" + this.servicio.rTraduccion()[352] + "', '" + this.servicio.rTraduccion()[353] + "'), a.ciclo, a.creacion, a.prioridad, a.parte, b.referencia, b.nombre, a.proceso, d.nombre, a.equipo, e.nombre FROM " + this.servicio.rBD() + ".listado01_detalle a INNER JOIN " + this.servicio.rBD() + ".cat_partes b ON a.parte = b.id INNER JOIN " + this.servicio.rBD() + ".lotes c ON a.lote = c.id INNER JOIN " + this.servicio.rBD() + ".cat_procesos d ON a.proceso = d.id INNER JOIN " + this.servicio.rBD() + ".cat_procesos e ON a.equipo = e.id ORDER BY a.lote, a.secuencia) ";
              this.exportar();
            }
            if (result.accion == 2) 
            {
        ...
        {
          this.sentenciaR = "SELECT '" + this.servicio.rTraduccion()[150] + "', '" + this.servicio.rTraduccion()[2036] + "', '" + this.servicio.rTraduccion()[2037] + "', '" + this.servicio.rTraduccion()[2038] + "', '" + this.servicio.rTraduccion()[572] + "', '" + this.servicio.rTraduccion()[3468] + "', '" + this.servicio.rTraduccion()[2039] + "', '" + this.servicio.rTraduccion()[2040] + "', '" + this.servicio.rTraduccion()[2041] + "', '" + this.servicio.rTraduccion()[2042] + "', '" + this.servicio.rTraduccion()[2043] + "', '" + (this.servicio.rVersion().modulos[5] == 1 || this.servicio.rVersion().modulos[10] == 1 ? this.servicio.rTraduccion()[3751] + "', '" : "") + this.servicio.rTraduccion()[2044] + "', '" + this.servicio.rTraduccion()[2045] + "', '" + this.servicio.rTraduccion()[2046] + "', '" + this.servicio.rTraduccion()[2047] + "', '" + this.servicio.rTraduccion()[2048] + "', '" + this.servicio.rTraduccion()[2049] + "', '" + this.servicio.rTraduccion()[2050] + "', '" + this.servicio.rTraduccion()[2051] + "', '" + this.servicio.rTraduccion()[2052] + "', '" + this.servicio.rTraduccion()[2053] + "', '" + this.servicio.rTraduccion()[2054] + "', '" + this.servicio.rTraduccion()[2055] + "', '" + this.servicio.rTraduccion()[2056] + "', '" + this.servicio.rTraduccion()[2057] + "', '" + this.servicio.rTraduccion()[2058] + "', '" + this.servicio.rTraduccion()[2059] + "', '" + this.servicio.rTraduccion()[2060] + "', '" + this.servicio.rTraduccion()[2061] + "', '" + this.servicio.rTraduccion()[2062] + "', '" + this.servicio.rTraduccion()[2063] + "', '" + this.servicio.rTraduccion()[2064] + "', '" + this.servicio.rTraduccion()[2065] + "', '" + this.servicio.rTraduccion()[2066] + "', '" + this.servicio.rTraduccion()[2067] + "', '" + this.servicio.rTraduccion()[2096] + "', '" + this.servicio.rTraduccion()[2068] + "', '" + this.servicio.rTraduccion()[2069] + "'" + (this.servicio.rVersion().modulos[2] == 1 ? ", '" + this.servicio.rTraduccion()[1356] + "', '" + this.servicio.rTraduccion()[2070] + "', '" + this.servicio.rTraduccion()[2071] + "', '" + this.servicio.rTraduccion()[2072] + "', '" + this.servicio.rTraduccion()[2073] + "', '" + this.servicio.rTraduccion()[2074] + "', '" + this.servicio.rTraduccion()[2075] + "', '" + this.servicio.rTraduccion()[2076] + "', '" + this.servicio.rTraduccion()[584] + "', '" + this.servicio.rTraduccion()[2077] + "', '" + this.servicio.rTraduccion()[1557] + "', '" + this.servicio.rTraduccion()[2078] + "', '" + this.servicio.rTraduccion()[2079] + "', '" + this.servicio.rTraduccion()[2080] + "', '" + this.servicio.rTraduccion()[2081] + "', '" + this.servicio.rTraduccion()[2082] + "', '" + this.servicio.rTraduccion()[233] + "', '" + this.servicio.rTraduccion()[2083] + "', '" + this.servicio.rTraduccion()[2084] + "', '" + this.servicio.rTraduccion()[748] + "', '" + this.servicio.rTraduccion()[2085] + "' " : "") + " UNION SELECT c.id, IF(c.origen = 0, '" + this.servicio.rTraduccion()[2086] + "', '" + this.servicio.rTraduccion()[1296] + "'), c.fecha, c.fecha_reporte, IFNULL(l.nombre, '" + this.servicio.rTraduccion()[8] + "'), c.estatus, c.inicio_atencion, c.tiempollegada, c.cierre_atencion, c.tiemporeparacion, c.tiemporeparacion + c.tiempollegada, " + (this.servicio.rVersion().modulos[5] == 1 || this.servicio.rVersion().modulos[10] == 1 ?  "IF(c.ultimo_rate > 0, (c.tiemporeparacion + c.tiempollegada) / c.ultimo_rate, 0), " : "") + "c.inicio_reporte, c.cierre_reporte, c.tiemporeporte, IFNULL(a.nombre, '" + this.servicio.rTraduccion()[8] + "'), c.linea, IFNULL(b.nombre, '" + this.servicio.rTraduccion()[8] + "'), c.maquina, IFNULL(d.nombre, '" + this.servicio.rTraduccion()[8] + "'), c.area, IFNULL(e.nombre, '" + this.servicio.rTraduccion()[8] + "'), c.falla_ajustada, IFNULL(f.nombre, '" + this.servicio.rTraduccion()[8] + "'), IFNULL(j.nombre, '" + this.servicio.rTraduccion()[8] + "'), IFNULL(h.nombre, '" + this.servicio.rTraduccion()[8] + "'), IFNULL(g.nombre, '" + this.servicio.rTraduccion()[8] + "'), IFNULL(m.nombre, '" + this.servicio.rTraduccion()[8] + "'), IFNULL(k.nombre, '" + this.servicio.rTraduccion()[8] + "'), c.detalle, IF(c.contabilizar = 'S', '" + this.servicio.rTraduccion()[352] + "', '" + this.servicio.rTraduccion()[353] + "'), IFNULL(v.nombre, '" + this.servicio.rTraduccion()[8] + "'), c.contabilizar_fecha, IF(c.alarmado = 'N', '" + this.servicio.rTraduccion()[353] + "', '" + this.servicio.rTraduccion()[352] + "'), IF(c.alarmado_atender = 'N', '" + this.servicio.rTraduccion()[353] + "', '" + this.servicio.rTraduccion()[352] + "'), IF(c.alarmado_atendido = 'N', '" + this.servicio.rTraduccion()[353] + "', '" + this.servicio.rTraduccion()[352] + "'), c.escalado, IFNULL(i.nombre , '" + this.servicio.rTraduccion()[8] + "'), c.falla " + (this.servicio.rVersion().modulos[2] == 1 ? ", w.nombre, w.referencia, z.p1, z.p2, z.p3, z.p4, z.p5, z.plan, z.fecha, z.responsable, z.departamento, z.mano_de_obra, z.material, z.metodo, z.maquina, z.medio_ambiente, z.comentarios, y.nombre, x.nombre, z.creacion, z.modificacion " : "") + " FROM " + this.servicio.rBD() + ".reportes c LEFT JOIN " + this.servicio.rBD() + ".cat_lineas a ON c.linea = a.id LEFT JOIN " + this.servicio.rBD() + ".cat_maquinas b ON c.maquina = b.id LEFT JOIN " + this.servicio.rBD() + ".cat_areas d ON c.area = d.id LEFT JOIN " + this.servicio.rBD() + ".cat_fallas e ON c.falla_ajustada = e.id LEFT JOIN " + this.servicio.rBD() + ".cat_usuarios f ON c.solicitante = f.id LEFT JOIN " + this.servicio.rBD() + ".cat_usuarios g ON c.tecnico = g.id LEFT JOIN " + this.servicio.rBD() + ".cat_usuarios h ON c.tecnicoatend = h.id LEFT JOIN " + this.servicio.rBD() + ".cat_fallas i ON c.falla = i.id LEFT JOIN " + this.servicio.rBD() + ".cat_generales j ON f.departamento = j.id LEFT JOIN " + this.servicio.rBD() + ".cat_generales k ON c.tipo = k.id LEFT JOIN " + this.servicio.rBD() + ".cat_turnos l ON c.turno = l.id LEFT JOIN " + this.servicio.rBD() + ".cat_usuarios m ON c.confirmado = m.id LEFT JOIN " + this.servicio.rBD() + ".causa_raiz z ON c.id = z.reporte LEFT JOIN " + this.servicio.rBD() + ".cat_usuarios y ON z.creado = y.id LEFT JOIN " + this.servicio.rBD() + ".cat_usuarios x ON z.modificado = x.id LEFT JOIN " + this.servicio.rBD() + ".cat_partes w ON c.herramental = w.id LEFT JOIN " + this.servicio.rBD() + ".cat_usuarios v ON c.contabilizar_usuario = v.id WHERE c.estatus >= 0 " + this.filtroReportes + " ";
          if (this.reporteSel==2)
          {
            this.sentenciaR = "SELECT '" + this.servicio.rTraduccion()[558] + "', '" + this.servicio.rTraduccion()[584] + "', '" + this.servicio.rTraduccion()[2087] + "', '" + this.servicio.rTraduccion()[579] + "', '" + this.servicio.rTraduccion()[2088] + "', '" + this.servicio.rTraduccion()[2089] + "' UNION SELECT id, fecha, CASE WHEN aplicacion = 20 THEN '" + this.servicio.rTraduccion()[1296] + "' WHEN aplicacion = 30 THEN '" + this.servicio.rTraduccion()[2478] + "' WHEN aplicacion = 40 THEN '" + this.servicio.rTraduccion()[2479] + "' WHEN aplicacion = 50 THEN '" + this.servicio.rTraduccion()[2480] + "' WHEN aplicacion = 60 THEN '" + this.servicio.rTraduccion()[2481] + "' WHEN aplicacion = 70 THEN '" + this.servicio.rTraduccion()[2482] + "' WHEN aplicacion = 80 THEN '" + this.servicio.rTraduccion()[2483] + "' ELSE '" + this.servicio.rTraduccion()[2484] + "' END, CASE WHEN tipo = 0 THEN '" + this.servicio.rTraduccion()[2485] + "' WHEN tipo = 2 THEN '" + this.servicio.rTraduccion()[2486] + "' WHEN tipo = 9 THEN '" + this.servicio.rTraduccion()[2487] + "' ELSE '" + this.servicio.rTraduccion()[2488] + "' END, proceso, texto FROM " + this.servicio.rBD() + ".log WHERE id >= 0 AND " + this.filtroFechas + " ";
          }
          else if (this.reporteSel==3)
          {
            this.sentenciaR = "SELECT '" + this.servicio.rTraduccion()[2489] + "', '" + this.servicio.rTraduccion()[2090] + "', '" + this.servicio.rTraduccion()[837] + "', '" + this.servicio.rTraduccion()[2091] + "', '" + this.servicio.rTraduccion()[2092] + "', '" + this.servicio.rTraduccion()[2093] + "', '" + this.servicio.rTraduccion()[2055] + "', '" + this.servicio.rTraduccion()[1354] + "', '" + this.servicio.rTraduccion()[2094] + "', '" + this.servicio.rTraduccion()[2095] + "', '" + this.servicio.rTraduccion()[2096] + "', '" + this.servicio.rTraduccion()[2097] + "' UNION (SELECT a.proceso, IF(c.estatus = 0, '" + this.servicio.rTraduccion()[160] + "', IF(c.estatus = 10, '" + this.servicio.rTraduccion()[161] + "', IF(c.estatus = 100, '" + this.servicio.rTraduccion()[162] + "', '" + this.servicio.rTraduccion()[163] + "'))), b.nombre, a.inicio, a.fin, IF(ISNULL(a.fin), TIMEDIFF(NOW(), a.inicio), SEC_TO_TIME(tiempo)), IFNULL(e.nombre, '" + this.servicio.rTraduccion()[8] + "') AS nsolicitante, IFNULL(g.nombre, '" + this.servicio.rTraduccion()[8] + "') AS nmaquina, IFNULL(d.nombre, '" + this.servicio.rTraduccion()[8] + "') AS narea, IFNULL(f.nombre, '" + this.servicio.rTraduccion()[8] + "') AS ntecnico, IF(a.fase - 10 < 0, '" + this.servicio.rTraduccion()[8] + "', a.fase - 10), a.repeticiones FROM " + this.servicio.rBD() + ".alarmas a INNER JOIN " + this.servicio.rBD() + ".cat_alertas b ON a.alerta = b.id LEFT JOIN " + this.servicio.rBD() + ".reportes c ON a.proceso = c.id LEFT JOIN " + this.servicio.rBD() + ".cat_areas d ON c.AREA = d.id LEFT JOIN " + this.servicio.rBD() + ".cat_maquinas g ON c.maquina = g.id LEFT JOIN " + this.servicio.rBD() + ".cat_usuarios e ON c.solicitante = e.id LEFT JOIN " + this.servicio.rBD() + ".cat_usuarios f ON c.tecnico = f.id WHERE a.id >= 0 AND " + this.filtroAlarmas + ") ";
            
          }
          else if (this.reporteSel==4)
          {
            this.sentenciaR = "SELECT '" + this.servicio.rTraduccion()[2490] + "', '" + this.servicio.rTraduccion()[2098] + "', '" + this.servicio.rTraduccion()[2099] + "', '" + this.servicio.rTraduccion()[572] + "', '" + this.servicio.rTraduccion()[1351] + "', '" + this.servicio.rTraduccion()[2047] + "', '" + this.servicio.rTraduccion()[2048] + "', '" + this.servicio.rTraduccion()[2049] + "', '" + this.servicio.rTraduccion()[2050] + "', '" + this.servicio.rTraduccion()[728] + "', '" + this.servicio.rTraduccion()[2100] + "', '" + this.servicio.rTraduccion()[2101] + "', '" + this.servicio.rTraduccion()[2102] + "', '" + this.servicio.rTraduccion()[2103] + "', '" + this.servicio.rTraduccion()[2104] + "', '" + this.servicio.rTraduccion()[2105] + "', '" + this.servicio.rTraduccion()[2106] + "', '" + this.servicio.rTraduccion()[2107] + "', '" + this.servicio.rTraduccion()[2108] + "', '" + this.servicio.rTraduccion()[2109] + "', '" + this.servicio.rTraduccion()[2110] + "', '" + this.servicio.rTraduccion()[2111] + "', '" + this.servicio.rTraduccion()[2112] + "', '" + this.servicio.rTraduccion()[2113] + "', '" + this.servicio.rTraduccion()[2114] + "', '" + this.servicio.rTraduccion()[2115] + "', '" + this.servicio.rTraduccion()[2116] + "', '" + this.servicio.rTraduccion()[2117] + "', '" + this.servicio.rTraduccion()[2118] + "', '" + this.servicio.rTraduccion()[2119] + "', '" + this.servicio.rTraduccion()[2120] + "', '" + this.servicio.rTraduccion()[2121] + "' UNION (SELECT c.id, c.dia, b.numero, a.nombre, c.turno, e.nombre, d.linea, d.nombre, c.equipo, f.nombre, f.referencia, c.parte, g.nombre, c.tripulacion, c.tc, IF(c.tc > 0, 1 / c.tc, 0), c.produccion, c.produccion_tc, c.calidad, c.calidad_tc, c.buffer, c.paro AS tparo, c.tiempo_disponible, IF(c.tiempo_disponible > 0, c.produccion_tc / (c.tiempo_disponible - (SELECT tparo)) * 100, 0) AS i1, IF((SELECT i1) > 100, 100, (SELECT i1)), IF(c.tiempo_disponible > 0, (1 - (SELECT tparo) / c.tiempo_disponible) * 100, 0) AS i2, IF(c.produccion_tc > 0, (1 - c.calidad_tc / c.produccion_tc) * 100, 0) AS i3, (IF((SELECT i1) > 100, 100, (SELECT i1)) * IF((SELECT i2) > 100, 100, (SELECT i2)) * IF((SELECT i3) > 100, 100, (SELECT i3)) / 10000), IF(c.tiempo_disponible > 0, c.produccion / c.tiempo_disponible, 0), IF(c.produccion  > 0, c.tiempo_disponible / c.produccion, 0), c.bloque_inicia, c.bloque_finaliza FROM " + this.servicio.rBD() + ".lecturas_cortes c LEFT JOIN " + this.servicio.rBD() + ".lotes b ON c.orden = b.id LEFT JOIN " + this.servicio.rBD() + ".cat_turnos a ON c.turno = a.id LEFT JOIN " + this.servicio.rBD() + ".cat_maquinas d ON c.equipo = d.id LEFT JOIN " + this.servicio.rBD() + ".cat_lineas e ON d.linea = e.id LEFT JOIN " + this.servicio.rBD() + ".cat_partes f ON c.parte = f.id LEFT JOIN " + this.servicio.rBD() + ".cat_tripulacion g ON c.tripulacion = g.id WHERE c.id >= 0 " + this.filtroOEE + ") ";
            
          }
          else if (this.reporteSel==10)
          {
            this.sentenciaR = "SELECT '" + this.servicio.rTraduccion()[3720] + "', '" + this.servicio.rTraduccion()[584] + "', '" + this.servicio.rTraduccion()[1341] + "', '" + this.servicio.rTraduccion()[3721] + "', '" + this.servicio.rTraduccion()[728] + "', '" + this.servicio.rTraduccion()[572] + "', '" + this.servicio.rTraduccion()[3718] + "', '" + this.servicio.rTraduccion()[1299] + "', '" + this.servicio.rTraduccion()[1300] + "', '" + this.servicio.rTraduccion()[3722] + "', '" + this.servicio.rTraduccion()[3723] + "', '" + this.servicio.rTraduccion()[3724] + "', '" + this.servicio.rTraduccion()[2076] + "', '" + this.servicio.rTraduccion()[3644] + "', '" + this.servicio.rTraduccion()[3725] + "', '" + this.servicio.rTraduccion()[3691] + "', '" + this.servicio.rTraduccion()[3726] + "', '" + this.servicio.rTraduccion()[3727] + "', '" + this.servicio.rTraduccion()[3728] + "', '" + this.servicio.rTraduccion()[3729] + "', '" + this.servicio.rTraduccion()[3749] + "', '" + this.servicio.rTraduccion()[575] + "', '" + this.servicio.rTraduccion()[576] + "', '" + this.servicio.rTraduccion()[577] + "', '" + this.servicio.rTraduccion()[1323] + "', '" + this.servicio.rTraduccion()[3730] + "', '" + this.servicio.rTraduccion()[3731] + "', '" + this.servicio.rTraduccion()[3732] + "', '" + this.servicio.rTraduccion()[2102] + "', '" + this.servicio.rTraduccion()[233] + "', '" + this.servicio.rTraduccion()[3710]  + "', '" + this.servicio.rTraduccion()[3711] + "', '" + this.servicio.rTraduccion()[3712] + "' UNION (SELECT CASE WHEN a.ruptura = 0 THEN '" + this.servicio.rTraduccion()[3718] + "' WHEN a.ruptura = 1 THEN '" + this.servicio.rTraduccion()[572] + "' WHEN a.ruptura = 2 THEN '" + this.servicio.rTraduccion()[3312] + "' WHEN a.ruptura = 3 THEN '" + this.servicio.rTraduccion()[728] + "' WHEN a.ruptura = 4 THEN '" + this.servicio.rTraduccion()[3721] + "' ELSE '" + this.servicio.rTraduccion()[3718] + "' END, a.dia, b.nombre, c.numero, i.nombre, d.nombre, a.hora, a.desde, a.hasta, IF(a.disponible = 3599, 3600, a.disponible), a.paro, a.tc, a.plan, a.plan_van, a.buenas - a.malas, a.malas, a.buenas, (a.plan - a.buenas) * -1, IF(IF(a.plan > 0, (a.buenas / a.plan ) * 100, 0) > 100, 100, IF(a.plan > 0, (a.buenas / a.plan ) * 100, 0)), a.buenas_vienen + a.malas_vienen, a.scrap, IF((a.tiempo - a.paro) > 0, (a.buenas_tc) / (a.tiempo - a.paro) * 100, 0) AS rendimiento, IF(a.malas > 0, (1 - a.malas_tc / a.buenas_tc) * 100, 100) AS calidad, IF(a.paro > 0 AND a.tiempo > 0, (1 - a.paro / a.tiempo) * 100, 100) AS disponibilidades, (SELECT IF(rendimiento > 100, 100, rendimiento)) * (SELECT calidad) * (SELECT disponibilidades) / 10000, IF(a.buenas > 0, a.tiempo / a.buenas, 0) AS tcreal, a.diferencia_vienen, IF(A.tipo = 0, '" + this.servicio.rTraduccion()[353] + "', '" + this.servicio.rTraduccion()[352] + "'), e.nombre, a.comentarios, f.nombre, g.nombre, h.nombre FROM " + this.servicio.rBD() + ".horaxhora a LEFT JOIN " + this.servicio.rBD() + ".cat_maquinas b ON a.equipo = b.id LEFT JOIN " + this.servicio.rBD() + ".lotes c ON a.lote = c.id LEFT JOIN " + this.servicio.rBD() + ".cat_turnos d ON a.turno = d.id LEFT JOIN " + this.servicio.rBD() + ".cat_tripulacion e ON a.tripulacion_inicial = e.id LEFT JOIN " + this.servicio.rBD() + ".cat_generales f ON a.causa = f.id LEFT JOIN " + this.servicio.rBD() + ".cat_generales g ON a.responsable = g.id LEFT JOIN " + this.servicio.rBD() + ".cat_generales h ON a.responsable2 = h.id LEFT JOIN " + this.servicio.rBD() + ".cat_partes i ON a.parte = i.id WHERE a.estatus IN ('A', 'Z') " + this.filtroHXH + ") ";
            
          }
          else if (this.reporteSel==5)
          {
          this.sentenciaR = "SELECT '" + this.servicio.rTraduccion()[558] + "', '" + this.servicio.rTraduccion()[2122] + "', '" + this.servicio.rTraduccion()[2123] + "', '" + this.servicio.rTraduccion()[2124] + "', '" + this.servicio.rTraduccion()[2125] + "', '" + this.servicio.rTraduccion()[2126] + "', '" + this.servicio.rTraduccion()[2127] + "', '" + this.servicio.rTraduccion()[2128] + "', '" + this.servicio.rTraduccion()[707] + "', '" + this.servicio.rTraduccion()[2129] + "', '" + this.servicio.rTraduccion()[2130] + "', '" + this.servicio.rTraduccion()[2131] + "', '" + this.servicio.rTraduccion()[2132] + "', '" + this.servicio.rTraduccion()[754] + "', '" + this.servicio.rTraduccion()[2133] + "', '" + this.servicio.rTraduccion()[2134] + "', '" + this.servicio.rTraduccion()[1896] + "', '" + this.servicio.rTraduccion()[1897] + "', '" + this.servicio.rTraduccion()[2135] + "', '" + this.servicio.rTraduccion()[2136] + "', '" + this.servicio.rTraduccion()[2137] + "', '" + this.servicio.rTraduccion()[2138] + "', '" + this.servicio.rTraduccion()[2139] + "', '" + this.servicio.rTraduccion()[2140] + "', '" + this.servicio.rTraduccion()[2141] + "', '" + this.servicio.rTraduccion()[2142] + "', '" + this.servicio.rTraduccion()[2143] + "', '" + this.servicio.rTraduccion()[2144] + "', '" + this.servicio.rTraduccion()[2145] + "' UNION ALL SELECT a.id, a.numero, a.inicia, a.estimada, a.finaliza, a.tiempo, a.tiempo_estimado, (a.tiempo_estimado - a.tiempo), IF(a.estatus = 'A', '" + this.servicio.rTraduccion()[1154] + "', '" + this.servicio.rTraduccion()[1155] + "') AS estatus, IFNULL(d.referencia, '" + this.servicio.rTraduccion()[8] + "') AS referencia, IFNULL(d.nombre, '" + this.servicio.rTraduccion()[8] + "') AS producto, IFNULL((SELECT MIN(orden) FROM " + this.servicio.rBD() + ".prioridades WHERE parte = a.parte AND proceso = a.proceso AND fecha >= NOW() AND estatus = 'A'), '" + this.servicio.rTraduccion()[8] + "') AS prioridad, j.carga  , CASE WHEN a.estado = 0 THEN '" + this.servicio.rTraduccion()[2274] + "' WHEN a.estado = 20 THEN '" + this.servicio.rTraduccion()[2276] + "' WHEN a.estado = 50 THEN '" + this.servicio.rTraduccion()[2275] + "' WHEN a.estado = 80 THEN 'En Inspeccion' WHEN a.estado = 90 THEN '" + this.servicio.rTraduccion()[2617] + "' WHEN a.estado = 99 THEN '" + this.servicio.rTraduccion()[1208] + "' END as estado, IFNULL(e.nombre, '" + this.servicio.rTraduccion()[8] + "') AS nproceso, IFNULL(b.nombre, '" + this.servicio.rTraduccion()[8] + "') AS nequipo, IFNULL(c.nombre, '" + this.servicio.rTraduccion()[8] + "') AS nruta_detalle, ruta_secuencia, a.inspecciones, a.inspeccion, IFNULL(f.nombre, '" + this.servicio.rTraduccion()[8] + "') AS insp_causa, IFNULL(h.nombre, '" + this.servicio.rTraduccion()[8] + "') AS insp_por, a.rechazos, a.rechazo, IFNULL(g.nombre, '" + this.servicio.rTraduccion()[8] + "') AS recha_causa, IFNULL(i.nombre, '" + this.servicio.rTraduccion()[8] + "') AS recha_por, a.alarmas, IF(a.alarma_tse = 'S', '" + this.servicio.rTraduccion()[352] + "', '" + this.servicio.rTraduccion()[353] + "'), IF(a.alarma_tpe = 'S', '" + this.servicio.rTraduccion()[352] + "', '" + this.servicio.rTraduccion()[353] + "') FROM " + this.servicio.rBD() + ".lotes a LEFT JOIN " + this.servicio.rBD() + ".cat_maquinas b ON a.equipo = b.id LEFT JOIN " + this.servicio.rBD() + ".det_rutas c ON a.ruta_detalle = c.id LEFT JOIN " + this.servicio.rBD() + ".cat_partes d ON a.parte = d.id LEFT JOIN " + this.servicio.rBD() + ".cat_procesos e ON a.proceso = e.id LEFT JOIN " + this.servicio.rBD() + ".cat_situaciones f ON a.inspeccion_id = f.id LEFT JOIN " + this.servicio.rBD() + ".cat_situaciones g ON a.rechazo_id = g.id LEFT JOIN " + this.servicio.rBD() + ".cat_usuarios h ON a.inspeccionado_por = h.id LEFT JOIN " + this.servicio.rBD() + ".cat_usuarios i ON a.rechazado_por = i.id LEFT JOIN " + this.servicio.rBD() + ".cargas j ON a.carga = j.id WHERE a.id > 0 " + this.filtroWIP + " "; 
          }
          else if (this.reporteSel==6)
          {
            this.sentenciaR = "SELECT '" + this.servicio.rTraduccion()[1349] + "', '" + this.servicio.rTraduccion()[2146] + "', '" + this.servicio.rTraduccion()[698] + "', '" + this.servicio.rTraduccion()[1897] + "', '" + this.servicio.rTraduccion()[2147] + "', '" + this.servicio.rTraduccion()[568] + "', '" + this.servicio.rTraduccion()[2123] + "', '" + this.servicio.rTraduccion()[2148] + "', '" + this.servicio.rTraduccion()[2149] + "', '" + this.servicio.rTraduccion()[2150] + "', '" + this.servicio.rTraduccion()[2151] + "', '" + this.servicio.rTraduccion()[700] + "', '" + this.servicio.rTraduccion()[1823] + "', '" + this.servicio.rTraduccion()[1826] + "', '" + this.servicio.rTraduccion()[2152] + "', '" + this.servicio.rTraduccion()[2153] + "', '" + this.servicio.rTraduccion()[2128] + "', '" + this.servicio.rTraduccion()[2154] + "', '" + this.servicio.rTraduccion()[2155] + "', '" + this.servicio.rTraduccion()[2156] + "', '" + this.servicio.rTraduccion()[2157] + "' UNION ALL SELECT b.numero, IFNULL(c.nombre, '" + this.servicio.rTraduccion()[8] + "'), IFNULL(c.referencia, '" + this.servicio.rTraduccion()[8] + "'), a.ruta_secuencia, IFNULL(d.nombre, '" + this.servicio.rTraduccion()[8] + "'), IFNULL(e.nombre, '" + this.servicio.rTraduccion()[8] + "'), a.fecha_entrada, a.fecha_stock, a.fecha_proceso, a.fecha_estimada, a.fecha_salida, a.tiempo_espera, a.tiempo_stock, a.tiempo_proceso, a.tiempo_total, a.tiempo_estimado, (a.tiempo_estimado - a.tiempo_total), a.ruta_secuencia_antes, IFNULL(f.nombre, '" + this.servicio.rTraduccion()[8] + "'), IF(a.alarma_so = 'N', '" + this.servicio.rTraduccion()[1892] + "', '" + this.servicio.rTraduccion()[1891] + "'), a.reversos FROM " + this.servicio.rBD() + ".lotes_historia a LEFT JOIN " + this.servicio.rBD() + ".lotes b ON a.lote = b.id LEFT JOIN " + this.servicio.rBD() + ".cat_partes c ON b.parte = c.id LEFT JOIN " + this.servicio.rBD() + ".cat_procesos d ON a.proceso = d.id LEFT JOIN " + this.servicio.rBD() + ".cat_maquinas e ON a.equipo = e.id LEFT JOIN " + this.servicio.rBD() + ".cat_procesos f ON a.proceso_anterior = f.id  WHERE a.id > 0 " + this.filtroTrazabilidad + " "; 
          }
          else if (this.reporteSel==7)
          {
          this.sentenciaR = "SELECT '" + this.servicio.rTraduccion()[763] + "', '" + this.servicio.rTraduccion()[2158] + "', '" + this.servicio.rTraduccion()[2159] + "', '" + this.servicio.rTraduccion()[2160] + "', '" + this.servicio.rTraduccion()[579] + "', '" + this.servicio.rTraduccion()[2161] + "', '" + this.servicio.rTraduccion()[2147] + "', '" + this.servicio.rTraduccion()[568] + "', '" + this.servicio.rTraduccion()[2162] + "', '" + this.servicio.rTraduccion()[2163] + "', '" + this.servicio.rTraduccion()[2164] + "', '" + this.servicio.rTraduccion()[2165] + "', '" + this.servicio.rTraduccion()[2166] + "' UNION ALL SELECT b.numero, IFNULL(d.nombre, '" + this.servicio.rTraduccion()[8] + "') AS producto, IFNULL(d.referencia, '" + this.servicio.rTraduccion()[8] + "') AS referencia, IFNULL(f.nombre, '" + this.servicio.rTraduccion()[8] + "') AS insp_causa, IF(a.tipo = 0, '" + this.servicio.rTraduccion()[1751] + "', '" + this.servicio.rTraduccion()[2167] + "'), IFNULL(h.nombre, '" + this.servicio.rTraduccion()[8] + "') AS insp_por, IFNULL(e.nombre, '" + this.servicio.rTraduccion()[8] + "') AS nproceso, IFNULL(i.nombre, '" + this.servicio.rTraduccion()[8] + "'), a.secuencia, IFNULL(j.nombre, '" + this.servicio.rTraduccion()[8] + "'), a.inicia, a.finaliza, a.tiempo FROM " + this.servicio.rBD() + ".calidad_historia a LEFT JOIN " + this.servicio.rBD() + ".lotes b ON a.lote = b.id LEFT JOIN " + this.servicio.rBD() + ".cat_partes d ON a.parte = d.id LEFT JOIN " + this.servicio.rBD() + ".cat_procesos e ON a.proceso = e.id LEFT JOIN " + this.servicio.rBD() + ".cat_situaciones f ON a.inspeccion_id = f.id LEFT JOIN " + this.servicio.rBD() + ".cat_usuarios h ON a.inspeccionado_por = h.id LEFT JOIN " + this.servicio.rBD() + ".cat_maquinas i ON a.equipo = i.id LEFT JOIN " + this.servicio.rBD() + ".det_rutas j ON a.secuencia = j.id WHERE a.id > 0 " + this.filtroCalidad + " "; 
          }
          else if (this.reporteSel==20)
          {
            this.sentenciaR = "SELECT '" + this.servicio.rTraduccion()[150] + "', '" + this.servicio.rTraduccion()[1766] + "', '" + this.servicio.rTraduccion()[3818] + "', '" + this.servicio.rTraduccion()[3819] + "', '" + this.servicio.rTraduccion()[3986] + "', '" + this.servicio.rTraduccion()[3418] + "', '" + this.servicio.rTraduccion()[4175] + "', '" + this.servicio.rTraduccion()[4244] + "', '" + this.servicio.rTraduccion()[4245] + "', '" + this.servicio.rTraduccion()[2604] + "', '" + this.servicio.rTraduccion()[4247] + "', '" + this.servicio.rTraduccion()[4248] + "', '" + this.servicio.rTraduccion()[4207] + "', '" + this.servicio.rTraduccion()[4249] + "', '" + this.servicio.rTraduccion()[4250] + "', '" + this.servicio.rTraduccion()[4251] + "', '" + this.servicio.rTraduccion()[1897] + "', '" + this.servicio.rTraduccion()[698] + "', '" + this.servicio.rTraduccion()[728] + "', '" + this.servicio.rTraduccion()[3905] + "', '" + this.servicio.rTraduccion()[3978] + "', '" + this.servicio.rTraduccion()[3979] + "', '" + this.servicio.rTraduccion()[644] + "', '" + this.servicio.rTraduccion()[4182] + "', '" + this.servicio.rTraduccion()[4252] + "', '" + this.servicio.rTraduccion()[4265] + "', '" + this.servicio.rTraduccion()[4253] + "', '" + this.servicio.rTraduccion()[4254] + "', '" + this.servicio.rTraduccion()[4255] + "', '" + this.servicio.rTraduccion()[4256] + "', '" + this.servicio.rTraduccion()[4257] + "', '" + this.servicio.rTraduccion()[4246] + "' UNION ALL (SELECT a.id, a.nombre, a.inicio, a.fin, b.nombre, c.nombre, a.notas, IF(a.tipo = 0, '" + this.servicio.rTraduccion()[4204] + "', '" + this.servicio.rTraduccion()[612] + "'), CASE WHEN a.estado = 0 THEN '" + this.servicio.rTraduccion()[4181] + "' WHEN a.estado = 5 THEN '" + this.servicio.rTraduccion()[4182] + "' WHEN a.estado = 10 THEN '" + this.servicio.rTraduccion()[3535] + "' WHEN a.estado = 20 THEN '" + this.servicio.rTraduccion()[2275] + "' WHEN a.estado = 50 THEN '" + this.servicio.rTraduccion()[1018] + "' WHEN a.estado = 90 THEN '" + this.servicio.rTraduccion()[4183] + "' END, a.alarmas, a.total_lineas, a.lineas_completadas, a.linea_siguiente, d.nombre, a.cancelado_fecha, IF(a.respetar_secuencia = 'S', '" + this.servicio.rTraduccion()[352] + "', '" + this.servicio.rTraduccion()[353] + "'), e.secuencia, f.referencia, f.nombre, i.nombre, e.cantidad_solicitada, e.cantidad_confirmada, k.nombre, e.planeado, e.ejecutado, j.nombre, g.nombre, e.cancelado_fecha, h.nombre, IF(e.alarmado = 'S', '" + this.servicio.rTraduccion()[352] + "', '" + this.servicio.rTraduccion()[353] + "'), e.alarmado_fecha, CASE WHEN e.estado = 0 THEN '" + this.servicio.rTraduccion()[4182] + "' WHEN e.estado = 5 THEN '" + this.servicio.rTraduccion()[4211] + "' WHEN e.estado = 10 THEN '" + this.servicio.rTraduccion()[3536] + "' WHEN e.estado = 90 THEN '" + this.servicio.rTraduccion()[4183] + "' WHEN e.estado = 99 THEN '" + this.servicio.rTraduccion()[4243] + "' END FROM " + this.servicio.rBD() + ".rkanban_cab a LEFT JOIN " + this.servicio.rBD() + ".cat_areas b ON a.area = b.id LEFT JOIN " + this.servicio.rBD() + ".cat_usuarios c ON a.usuario_asignado = c.id LEFT JOIN " + this.servicio.rBD() + ".cat_usuarios d ON a.cancelado_por = d.id INNER JOIN " + this.servicio.rBD() + ".rkanban_det e ON a.id = e.kanban LEFT JOIN " + this.servicio.rBD() + ".cat_partes f ON e.parte = f.id LEFT JOIN " + this.servicio.rBD() + ".cat_usuarios g ON e.ejecutado_por = g.id LEFT JOIN " + this.servicio.rBD() + ".cat_usuarios h ON e.cancelado_por = h.id INNER JOIN " + this.servicio.rBD() + ".cat_procesos i ON e.proceso = i.id LEFT JOIN " + this.servicio.rBD() + ".cat_turnos j ON e.turno_entrega = j.id LEFT JOIN sigma.cat_generales k ON f.kanban_unidad = k.id WHERE a.id > 0 " + this.filtroKRS + " ORDER BY a.id, e.secuencia) "; 
          }
          else if (this.reporteSel==21)
          {
            this.sentenciaR = "SELECT '" + this.servicio.rTraduccion()[150] + "', '" + this.servicio.rTraduccion()[4262] + "', '" + this.servicio.rTraduccion()[4263] + "', '" + this.servicio.rTraduccion()[2098] + "', '" + this.servicio.rTraduccion()[4264] + "', '" + this.servicio.rTraduccion()[4265] + "', '" + this.servicio.rTraduccion()[698] + "', '" + this.servicio.rTraduccion()[3906] + "', '" + this.servicio.rTraduccion()[4044] + "', '" + this.servicio.rTraduccion()[754] + "', '" + this.servicio.rTraduccion()[3986] + "', '" + this.servicio.rTraduccion()[3978] + "', '" + this.servicio.rTraduccion()[3979] + "', '" + this.servicio.rTraduccion()[644] + "', '" + this.servicio.rTraduccion()[3878] + "', '" + this.servicio.rTraduccion()[4267] + "', '" + this.servicio.rTraduccion()[3861] + "', '" + this.servicio.rTraduccion()[4302] + "', '" + this.servicio.rTraduccion()[154] + "', '" + this.servicio.rTraduccion()[4268] + "', '" + this.servicio.rTraduccion()[4303] + "', '" + this.servicio.rTraduccion()[4269] + "' UNION ALL SELECT a.id, a.fecha_sugerida, IF(a.clase = 1, '" + this.servicio.rTraduccion()[4204] + "', '" + this.servicio.rTraduccion()[612] + "'), a.fecha_reporte, b.nombre, c.nombre, d.referencia, d.nombre, e.nombre, CASE WHEN a.estado = 0 THEN '" + this.servicio.rTraduccion()[4181] + "' WHEN a.estado = 10 THEN '" + this.servicio.rTraduccion()[4261] + "' WHEN a.estado = 50 THEN '" + this.servicio.rTraduccion()[3872] + "' WHEN a.estado = 90 THEN '" + this.servicio.rTraduccion()[4260] + "' END, f.nombre, a.cantidad_solicitada, a.cantidad_confirmada, i.nombre, a.fecha_entrega, a.tiempo, a.lead_time, IF(a.evaluacion = 'P', '" + this.servicio.rTraduccion()[4300] + "', '" + this.servicio.rTraduccion()[4301] + "'), g.nombre, h.nombre, j.nombre, IF(a.alarmado = 'S', '" + this.servicio.rTraduccion()[352] + "', '" + this.servicio.rTraduccion()[353] + "') FROM " + this.servicio.rBD() + ".kanban_solicitudes a LEFT JOIN " + this.servicio.rBD() + ".cat_turnos b ON a.turno = b.id LEFT JOIN " + this.servicio.rBD() + ".cat_turnos c ON a.turno_entrega = c.id INNER JOIN " + this.servicio.rBD() + ".cat_partes d ON a.parte = d.id INNER JOIN " + this.servicio.rBD() + ".cat_procesos e ON a.proceso = e.id LEFT JOIN " + this.servicio.rBD() + ".cat_areas f ON a.area = f.id LEFT JOIN " + this.servicio.rBD() + ".cat_usuarios g ON a.solicitante = g.id LEFT JOIN " + this.servicio.rBD() + ".cat_usuarios h ON a.surtidor = h.id LEFT JOIN sigma.cat_generales i ON d.kanban_unidad = i.id LEFT JOIN " + this.servicio.rBD() + ".cat_usuarios j ON a.confirmador = j.id WHERE a.id > 0 " + this.filtroK; 
          }
          else if (this.reporteSel==22)
          {
          this.sentenciaR = "SELECT '" + this.servicio.rTraduccion()[728] + "', '" + this.servicio.rTraduccion()[698] + "', '" + this.servicio.rTraduccion()[705] + "', '" + this.servicio.rTraduccion()[3986] + "', '" + this.servicio.rTraduccion()[4094] + "', '" + this.servicio.rTraduccion()[4006] + "', '" + this.servicio.rTraduccion()[644] + "' UNION ALL (SELECT d.nombre, d.referencia, e.nombre, f.nombre, saldo, por_surtir, i.nombre FROM " + this.servicio.rBD() + ".relacion_operaciones_partes a INNER JOIN " + this.servicio.rBD() + ".cat_partes d ON a.parte = d.id INNER JOIN " + this.servicio.rBD() + ".cat_procesos e ON a.proceso = e.id LEFT JOIN " + this.servicio.rBD() + ".cat_areas f ON a.area = f.id LEFT JOIN " + this.servicio.rBD() + ".cat_generales i ON d.kanban_unidad = i.id WHERE a.proceso > 0 " + this.filtroSaldo + " ORDER BY 1, 3) "
          }
          else if (this.reporteSel==23)
          {
            this.sentenciaR = "SELECT '" + this.servicio.rTraduccion()[150] + "', '" + this.servicio.rTraduccion()[584] + "', '" + this.servicio.rTraduccion()[4271] + "', '" + this.servicio.rTraduccion()[4272] + "', '" + this.servicio.rTraduccion()[572] + "', '" + this.servicio.rTraduccion()[728] + "', '" + this.servicio.rTraduccion()[698] + "', '" + this.servicio.rTraduccion()[705] + "', '" + this.servicio.rTraduccion()[3986] + "', '" + this.servicio.rTraduccion()[4273] + "', '" + this.servicio.rTraduccion()[586] + "', '" + this.servicio.rTraduccion()[4274] + "', '" + this.servicio.rTraduccion()[644] + "', '" + this.servicio.rTraduccion()[2161] + "', '" + this.servicio.rTraduccion()[4067] + "', '" + this.servicio.rTraduccion()[4088] + "' UNION ALL (SELECT a.id, a.fecha, IF(a.clase = 0, '" + this.servicio.rTraduccion()[4204] + "', '" + this.servicio.rTraduccion()[612] + "'), CASE WHEN a.tipo = 'R' THEN '" + this.servicio.rTraduccion()[4089] + "' WHEN a.tipo = 'C' THEN '" + this.servicio.rTraduccion()[4047] + "' WHEN a.tipo = 'A' THEN '" + this.servicio.rTraduccion()[4046] + "' END, b.nombre, d.nombre, d.referencia, e.nombre, f.nombre, a.saldo_ubicacion_antes, a.cantidad, a.saldo_ubicacion_antes + a.cantidad, i.nombre, g.nombre, a.notas, j.nombre FROM " + this.servicio.rBD() + ".kanban_movimientos a LEFT JOIN " + this.servicio.rBD() + ".cat_turnos b ON a.turno = b.id INNER JOIN " + this.servicio.rBD() + ".cat_partes d ON a.parte = d.id INNER JOIN " + this.servicio.rBD() + ".cat_procesos e ON a.proceso = e.id LEFT JOIN " + this.servicio.rBD() + ".cat_areas f ON a.area = f.id LEFT JOIN " + this.servicio.rBD() + ".cat_usuarios g ON a.usuario = g.id LEFT JOIN " + this.servicio.rBD() + ".cat_generales i ON d.kanban_unidad = i.id LEFT JOIN " + this.servicio.rBD() + ".cat_generales j ON a.causa = j.id WHERE a.id > 0 " + this.filtroMov + " ORDER BY a.fecha DESC) "; 
          }
          if (this.modelo == 3 || this.modelo == 13)
          {
            this.sentenciaR = "SELECT '" + this.servicio.rTraduccion()[2489] + "', '" + this.servicio.rTraduccion()[2090] + "', '" + this.servicio.rTraduccion()[837] + "', '" + this.servicio.rTraduccion()[2091] + "', '" + this.servicio.rTraduccion()[2093] + "', '" + this.servicio.rTraduccion()[2055] + "', '" + this.servicio.rTraduccion()[1354] + "', '" + this.servicio.rTraduccion()[2094] + "', '" + this.servicio.rTraduccion()[2095] + "', '" + this.servicio.rTraduccion()[2096] + "', '" + this.servicio.rTraduccion()[2097] + "' UNION (SELECT a.proceso, IF(c.estatus = 0, '" + this.servicio.rTraduccion()[160] + "', IF(c.estatus = 10, '" + this.servicio.rTraduccion()[161] + "', IF(c.estatus = 100, '" + this.servicio.rTraduccion()[162] + "', '" + this.servicio.rTraduccion()[163] + "'))), b.nombre, a.inicio, TIMEDIFF(NOW(), a.inicio), IFNULL(e.nombre, '" + this.servicio.rTraduccion()[8] + "') AS nsolicitante, IFNULL(g.nombre, '" + this.servicio.rTraduccion()[8] + "') AS nmaquina, IFNULL(d.nombre, '" + this.servicio.rTraduccion()[8] + "') AS narea, IFNULL(f.nombre, '" + this.servicio.rTraduccion()[8] + "') AS ntecnico, IF(a.fase - 10 < 0, '" + this.servicio.rTraduccion()[8] + "', a.fase - 10), a.repeticiones FROM " + this.servicio.rBD() + ".alarmas a INNER JOIN " + this.servicio.rBD() + ".cat_alertas b ON a.alerta = b.id LEFT JOIN " + this.servicio.rBD() + ".reportes c ON a.proceso = c.id LEFT JOIN " + this.servicio.rBD() + ".cat_areas d ON c.AREA = d.id LEFT JOIN " + this.servicio.rBD() + ".cat_maquinas g ON c.maquina = g.id LEFT JOIN " + this.servicio.rBD() + ".cat_usuarios e ON c.solicitante = e.id LEFT JOIN " + this.servicio.rBD() + ".cat_usuarios f ON c.tecnico = f.id WHERE ISNULL(a.fin) ORDER BY 3);";
          }
...
listarConsultas()
  ...
  listarProcesos()
  {
    ...
    let sentencia = "SELECT a.id, a.nombre, IF(ISNULL(b.valor), 0, 1) AS seleccionado FROM " + this.servicio.rBD() + ".cat_procesos a LEFT JOIN " + this.servicio.rBD() + ".consultas_det b ON b.valor = a.id AND b.tabla = 90 AND b.consulta = " + this.consultaTemp + cadAdicional + " ORDER BY seleccionado DESC, a.nombre;"
    this.procesos = [];
    let campos = {accion: 100, sentencia: sentencia};  
    this.servicio.consultasBD(campos).subscribe( resp =>
    {
  ...
  listarAreas()
  {
    let sentencia = "SELECT a.id, a.nombre, IF(ISNULL(b.valor), 0, 1) AS seleccionado FROM " + this.servicio.rBD() + ".cat_areas a LEFT JOIN " + this.servicio.rBD() + ".consultas_det b ON b.valor = a.id AND b.tabla = 30 AND b.consulta = " + this.consultaTemp + " WHERE a.andon = 'S' ORDER BY seleccionado DESC, a.nombre;"
    this.areas = [];
    let campos = {accion: 100, sentencia: sentencia};  
    this.servicio.consultasBD(campos).subscribe( resp =>
    {
    ...
    sentencia = "SELECT a.id, a.nombre, a.kanban, a.andon, IF(ISNULL(b.valor), 0, 1) AS seleccionado FROM " + this.servicio.rBD() + ".cat_areas a LEFT JOIN " + this.servicio.rBD() + ".consultas_det b ON b.valor = a.id AND b.tabla = 30 AND b.consulta = " + this.consultaTemp + " WHERE a.kanban = 'S' ORDER BY seleccionado DESC, a.nombre;"
    this.areas_k = [];
  ...
  listarPartes()
  {
    ...
    let sentencia = "SELECT a.id, IF(ISNULL(a.referencia), a.nombre, CONCAT(a.nombre, '" + this.servicio.rTraduccion()[2637] + "', a.referencia, ')')) AS nombre, IF(ISNULL(b.valor), 0, 1) AS seleccionado FROM " + this.servicio.rBD() + ".cat_partes a LEFT JOIN " + this.servicio.rBD() + ".consultas_det b ON b.valor = a.id AND b.tabla = 60 AND b.consulta = " + this.consultaTemp + cadAdicional + " ORDER BY seleccionado DESC, nombre;"
    this.partes = [];
    let campos = {accion: 100, sentencia: sentencia};  
    this.servicio.consultasBD(campos).subscribe( resp =>
    {
