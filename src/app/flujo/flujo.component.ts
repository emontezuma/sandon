...
export class FlujoComponent implements OnInit {
  ...
  llenarRegistros()
  {
    ...
    {
      sentencia = "SELECT a.id, a.cantidad, IFNULL((SELECT COUNT(*) FROM " + this.servicio.rBD() + ".lotes WHERE estatus = 'A' AND parte = a.parte AND carga = a.carga), 0) AS avance, IF(a.cantidad = 0, 0, FLOOR((SELECT avance) / a.cantidad * 100)) as pct, IFNULL(d.nombre, '" + this.servicio.rTraduccion()[8] + "') AS nombre, d.referencia, IFNULL(DATE_FORMAT(a.modificacion, '%Y/%m/%d %H:%i'), '" + this.servicio.rTraduccion()[8] + "') AS fcambio, IF(a.estatus = 'A', '" + this.servicio.rTraduccion()[1154] + "', '" + this.servicio.rTraduccion()[1155] + "') AS estatus, IFNULL(c.nombre, '" + this.servicio.rTraduccion()[8] + "') AS ucambio, b.imagen, 'S' AS mostrarImagen FROM " + this.servicio.rBD() + ".programacion a LEFT JOIN " + this.servicio.rBD() + ".cat_usuarios b ON a.creado = b.id LEFT JOIN " + this.servicio.rBD() + ".cat_usuarios c ON a.modificado = c.id LEFT JOIN " + this.servicio.rBD() + ".cat_partes d ON a.parte = d.id WHERE a.carga = " + this.idNivel0 + " ORDER BY d.nombre";
      this.sentenciaR =   "SELECT '" + this.servicio.rTraduccion()[558] + "', '" + this.servicio.rTraduccion()[2566] + "', '" + this.servicio.rTraduccion()[704] + "', '" + this.servicio.rTraduccion()[2245] + "', '" + this.servicio.rTraduccion()[2567] + "', '" + this.servicio.rTraduccion()[2568] + "', '" + this.servicio.rTraduccion()[2569] + "', '" + this.servicio.rTraduccion()[2570] + "', '" + this.servicio.rTraduccion()[2240] + "', '" + this.servicio.rTraduccion()[2579] + "', '" + this.servicio.rTraduccion()[2580] + "', '" + this.servicio.rTraduccion()[568] + "', '" + this.servicio.rTraduccion()[707] + "', '" + this.servicio.rTraduccion()[2575] + "', '" + this.servicio.rTraduccion()[2576] + "', '" + this.servicio.rTraduccion()[2577] + "'  UNION ALL SELECT a.id, a.carga, a.notas, a.fecha, a.fecha_anterior, a.reprogramaciones, a.fecha_original, IFNULL((SELECT COUNT(DISTINCT(parte)) FROM " + this.servicio.rBD() + ".programacion WHERE carga = a.id AND estatus = 'A'), 0), IFNULL((SELECT SUM(cantidad) FROM " + this.servicio.rBD() + ".programacion WHERE carga = a.id AND estatus = 'A'), 0) AS piezas, IFNULL((SELECT COUNT(*) FROM " + this.servicio.rBD() + ".lotes WHERE estatus = 'A' AND carga = a.id), 0) AS avance, IF((SELECT piezas) = 0, 0, FLOOR((SELECT avance) / (SELECT piezas) * 100)), IFNULL(d.nombre, '" + this.servicio.rTraduccion()[8] + "'), IF(a.estatus = 'A', '" + this.servicio.rTraduccion()[1154] + "', '" + this.servicio.rTraduccion()[1155] + "'), b.referencia, IFNULL(b.nombre, '" + this.servicio.rTraduccion()[8] + "'), c.cantidad FROM " + this.servicio.rBD() + ".cargas a LEFT JOIN " + this.servicio.rBD() + ".programacion c ON a.id = c.carga LEFT JOIN " + this.servicio.rBD() + ".cat_partes b ON c.parte = b.id LEFT JOIN " + this.servicio.rBD() + ".cat_maquinas d ON a.equipo = d.id";
    ...
    if (this.maestroActual == 1) 
    {
      ...
      sentencia = "SELECT a.id, a.fecha, d.nombre, IFNULL(e.nombre, '" + this.servicio.rTraduccion()[8] + "') AS nproceso, a.orden, d.referencia, IFNULL(DATE_FORMAT(a.modificacion, '%Y/%m/%d %H:%i'), '" + this.servicio.rTraduccion()[8] + "') AS fcambio, IF(a.estatus = 'A', '" + this.servicio.rTraduccion()[1154] + "', '" + this.servicio.rTraduccion()[1155] + "') AS estatus, IFNULL(c.nombre, '" + this.servicio.rTraduccion()[8] + "') AS ucambio, d.imagen, 'S' AS mostrarImagen FROM " + this.servicio.rBD() + ".prioridades a LEFT JOIN " + this.servicio.rBD() + ".cat_usuarios b ON a.creado = b.id LEFT JOIN " + this.servicio.rBD() + ".cat_usuarios c ON a.modificado = c.id LEFT JOIN " + this.servicio.rBD() + ".cat_partes d ON a.parte = d.id LEFT JOIN " + this.servicio.rBD() + ".cat_procesos e ON a.proceso = e.id ORDER BY a.orden, a.fecha, d.nombre";
      this.sentenciaR =   "SELECT '" + this.servicio.rTraduccion()[558] + "', '" + this.servicio.rTraduccion()[2575] + "', '" + this.servicio.rTraduccion()[2576] + "', '" + this.servicio.rTraduccion()[2131] + "', '" + this.servicio.rTraduccion()[2581] + "', '" + this.servicio.rTraduccion()[2582] + "', '" + this.servicio.rTraduccion()[2583] + "', '" + this.servicio.rTraduccion()[704] + "', '" + this.servicio.rTraduccion()[707] + "' UNION ALL SELECT a.id, d.referencia, IFNULL(d.nombre, '" + this.servicio.rTraduccion()[8] + "'), a.orden, a.fecha, IFNULL(e.nombre, '" + this.servicio.rTraduccion()[8] + "'), (SELECT COUNT(*) FROM " + this.servicio.rBD() + ".lotes WHERE estado <= 50 AND estatus = 'A' AND estado <= 50 AND proceso = a.proceso AND estatus = 'A'), a.notas, IF(a.estatus = 'A', '" + this.servicio.rTraduccion()[1154] + "', '" + this.servicio.rTraduccion()[1155] + "') FROM " + this.servicio.rBD() + ".prioridades a LEFT JOIN " + this.servicio.rBD() + ".cat_partes d ON a.parte = d.id LEFT JOIN " + this.servicio.rBD() + ".cat_procesos e ON a.proceso = e.id";
    ...
    if (this.maestroActual == 2) 
    {
      ...
      this.sentenciaR =   "SELECT '" + this.servicio.rTraduccion()[763] + "', '" + this.servicio.rTraduccion()[2575] + "', '" + this.servicio.rTraduccion()[2576] + "', '" + this.servicio.rTraduccion()[2131] + "', '" + this.servicio.rTraduccion()[2584] + "', '" + this.servicio.rTraduccion()[2585] + "', '" + this.servicio.rTraduccion()[2586] + "', '" + this.servicio.rTraduccion()[2587] + "', '" + this.servicio.rTraduccion()[2582] + "', '" + this.servicio.rTraduccion()[2588] + "' UNION ALL SELECT a.numero, d.referencia, IFNULL(d.nombre, '" + this.servicio.rTraduccion()[8] + "'), IFNULL((SELECT MIN(orden) FROM " + this.servicio.rBD() + ".prioridades WHERE parte = a.parte  AND proceso = a.proceso AND fecha >= NOW() AND estatus = 'A'), '" + this.servicio.rTraduccion()[8] + "'), a.inspeccion, IFNULL(c.referencia, '" + this.servicio.rTraduccion()[8] + "'), IFNULL(c.nombre, '" + this.servicio.rTraduccion()[8] + "'), IFNULL(b.nombre, '" + this.servicio.rTraduccion()[8] + "'), IFNULL(e.nombre, '" + this.servicio.rTraduccion()[8] + "'), a.ruta_secuencia FROM " + this.servicio.rBD() + ".lotes a LEFT JOIN " + this.servicio.rBD() + ".cat_usuarios b ON a.inspeccionado_por = b.id LEFT JOIN " + this.servicio.rBD() + ".cat_situaciones c ON a.inspeccion_id = c.id LEFT JOIN " + this.servicio.rBD() + ".cat_partes d ON a.parte = d.id LEFT JOIN " + this.servicio.rBD() + ".cat_procesos e ON a.proceso = e.id WHERE a.estado = 80";
    ...
    if (this.maestroActual == 3) 
    {
      ...
      this.sentenciaR =   "SELECT '" + this.servicio.rTraduccion()[763] + "', '" + this.servicio.rTraduccion()[2575] + "', '" + this.servicio.rTraduccion()[2576] + "', '" + this.servicio.rTraduccion()[2131] + "', '" + this.servicio.rTraduccion()[2589] + "', '" + this.servicio.rTraduccion()[2590] + "', '" + this.servicio.rTraduccion()[2533] + "', '" + this.servicio.rTraduccion()[2591] + "', '" + this.servicio.rTraduccion()[2582] + "', '" + this.servicio.rTraduccion()[2588] + "'  UNION ALL SELECT a.numero, d.referencia, IFNULL(d.nombre, '" + this.servicio.rTraduccion()[8] + "'), IFNULL((SELECT MIN(orden) FROM " + this.servicio.rBD() + ".prioridades WHERE parte = a.parte  AND proceso = a.proceso AND fecha >= NOW() AND estatus = 'A'), '" + this.servicio.rTraduccion()[8] + "'), a.rechazo, IFNULL(c.referencia, '" + this.servicio.rTraduccion()[8] + "'), IFNULL(c.nombre, '" + this.servicio.rTraduccion()[8] + "'), IFNULL(b.nombre, '" + this.servicio.rTraduccion()[8] + "'), IFNULL(e.nombre, '" + this.servicio.rTraduccion()[8] + "'), a.ruta_secuencia FROM " + this.servicio.rBD() + ".lotes a LEFT JOIN " + this.servicio.rBD() + ".cat_usuarios b ON a.rechazado_por = b.id LEFT JOIN " + this.servicio.rBD() + ".cat_situaciones c ON a.rechazo_id = c.id LEFT JOIN " + this.servicio.rBD() + ".cat_partes d ON a.parte = d.id LEFT JOIN " + this.servicio.rBD() + ".cat_procesos e ON a.proceso = e.id WHERE a.estado = 90";
    ...
    if (this.maestroActual == 4 && (this.vision==0 || this.vistaDetalle==1)) 
    {
      ...
      sentencia = "SELECT a.inicia, a.carga, IFNULL(f.carga, '" + this.servicio.rTraduccion()[8] + "') AS ncarga, a.finaliza, a.estimada, '" + this.servicio.rTraduccion()[1154] + "' as estatus, IFNULL((SELECT MIN(orden) FROM " + this.servicio.rBD() + ".prioridades WHERE parte = a.parte  AND proceso = a.proceso AND fecha >= NOW() AND estatus = 'A'), 10000) AS prioridad, a.id, a.numero, CASE WHEN a.estado = 0 THEN '" + this.servicio.rTraduccion()[2274] + "' WHEN a.estado = 20 THEN '" + this.servicio.rTraduccion()[2276] + "' WHEN a.estado = 50 THEN '" + this.servicio.rTraduccion()[2275] + "' WHEN a.estado = 80 THEN '" + this.servicio.rTraduccion()[2616] + "' WHEN a.estado = 90 THEN '" + this.servicio.rTraduccion()[2617] + "' WHEN a.estado = 99 THEN '" + this.servicio.rTraduccion()[1208] + "' END as estado, a.ruta_secuencia, a.fecha, IFNULL(a.hasta, '" + this.servicio.rTraduccion()[8] + "') AS hasta, IFNULL(e.nombre, '" + this.servicio.rTraduccion()[8] + "') AS nproceso, d.imagen, 'S' AS mostrarImagen, IFNULL(d.referencia, '" + this.servicio.rTraduccion()[8] + "') AS referencia, IFNULL(d.nombre, '" + this.servicio.rTraduccion()[8] + "') AS producto FROM " + this.servicio.rBD() + ".lotes a LEFT JOIN " + this.servicio.rBD() + ".cat_partes d ON a.parte = d.id LEFT JOIN " + this.servicio.rBD() + ".cat_procesos e ON a.proceso = e.id LEFT JOIN " + this.servicio.rBD() + ".cargas f ON a.carga = f.id WHERE " + adicional + " ORDER BY a.inspecciones DESC, 5, a.fecha, a.numero;";
      this.sentenciaR = "SELECT '" + this.servicio.rTraduccion()[558] + "', '" + this.servicio.rTraduccion()[2592] + "', '" + this.servicio.rTraduccion()[2575] + "', '" + this.servicio.rTraduccion()[2593] + "', '" + this.servicio.rTraduccion()[2594] + "', '" + this.servicio.rTraduccion()[2595] + "', '" + this.servicio.rTraduccion()[2150] + "', '" + this.servicio.rTraduccion()[2131] + "', '" + this.servicio.rTraduccion()[2582] + "', '" + this.servicio.rTraduccion()[2596] + "', '" + this.servicio.rTraduccion()[1897] + "', '" + this.servicio.rTraduccion()[754] + "', '" + this.servicio.rTraduccion()[2135] + "', '" + this.servicio.rTraduccion()[2597] + "', '" + this.servicio.rTraduccion()[2598] + "', '" + this.servicio.rTraduccion()[2599] + "', '" + this.servicio.rTraduccion()[2139] + "', '" + this.servicio.rTraduccion()[2600] + "', '" + this.servicio.rTraduccion()[2601] + "', '" + this.servicio.rTraduccion()[2602] + "', '" + this.servicio.rTraduccion()[2603] + "', '" + this.servicio.rTraduccion()[2604] + "', '" + this.servicio.rTraduccion()[2301] + "', '" + this.servicio.rTraduccion()[2300] + "' UNION ALL SELECT a.id, a.numero, IFNULL(d.referencia, '" + this.servicio.rTraduccion()[8] + "'), IFNULL(d.nombre, '" + this.servicio.rTraduccion()[8] + "'), a.inicia, a.finaliza, a.estimada, IFNULL((SELECT MIN(orden) FROM " + this.servicio.rBD() + ".prioridades WHERE parte = a.parte AND proceso = a.proceso AND fecha >= NOW() AND estatus = 'A'), '" + this.servicio.rTraduccion()[2605] + "') AS prioridad, IFNULL(e.nombre, '" + this.servicio.rTraduccion()[8] + "'), IFNULL(b.nombre, '" + this.servicio.rTraduccion()[8] + "'), a.ruta_secuencia, CASE WHEN a.estado = 0 THEN '" + this.servicio.rTraduccion()[2274] + "' WHEN a.estado = 20 THEN '" + this.servicio.rTraduccion()[2276] + "' WHEN a.estado = 50 THEN '" + this.servicio.rTraduccion()[2275] + "' WHEN a.estado = 80 THEN 'En Inspeccion' WHEN a.estado = 90 THEN '" + this.servicio.rTraduccion()[2617] + "' WHEN a.estado = 99 THEN '" + this.servicio.rTraduccion()[1208] + "' END as estado, a.inspecciones, IFNULL(f.nombre, '" + this.servicio.rTraduccion()[8] + "'), a.inspeccion, IFNULL(h.nombre, '" + this.servicio.rTraduccion()[8] + "'), a.rechazos, IFNULL(g.nombre, '" + this.servicio.rTraduccion()[8] + "'), a.rechazo, IFNULL(i.nombre, '" + this.servicio.rTraduccion()[8] + "'), j.carga, a.alarmas, IF(a.alarma_tse = 'S', '" + this.servicio.rTraduccion()[1891] + "', '" + this.servicio.rTraduccion()[1892] + "'), IF(a.alarma_tpe = 'S', '" + this.servicio.rTraduccion()[1891] + "', '" + this.servicio.rTraduccion()[1892] + "') FROM " + this.servicio.rBD() + ".lotes a LEFT JOIN " + this.servicio.rBD() + ".cat_maquinas b ON a.equipo = b.id LEFT JOIN " + this.servicio.rBD() + ".det_rutas c ON a.ruta_detalle = c.id LEFT JOIN " + this.servicio.rBD() + ".cat_partes d ON a.parte = d.id LEFT JOIN " + this.servicio.rBD() + ".cat_procesos e ON a.proceso = e.id LEFT JOIN " + this.servicio.rBD() + ".cat_situaciones f ON a.inspeccion_id = f.id LEFT JOIN " + this.servicio.rBD() + ".cat_situaciones g ON a.rechazo_id = g.id LEFT JOIN " + this.servicio.rBD() + ".cat_usuarios h ON a.inspeccionado_por = h.id LEFT JOIN " + this.servicio.rBD() + ".cat_usuarios i ON a.rechazado_por = i.id LEFT JOIN " + this.servicio.rBD() + ".cargas j ON a.carga = j.id WHERE " + adicional + " ";
      this.titulo_fecha = this.servicio.rTraduccion()[2521]
      this.iconoGeneral = "i_partes";
      this.nuevoRegistro = "";
    ...
    else if (this.maestroActual == 4 && this.vision > 0 && this.vistaDetalle==0)
    {
      this.nombreReg = "";
      mensajeNoHay=this.servicio.rTraduccion()[2515]
      sentencia = "SELECT a.id, a.nombre, a.referencia, a.capacidad_stock, IFNULL(z.capproceso, 0) AS cap_proceso, a.imagen, 'S' AS mostrarImagen, IFNULL(y.totall_2, 0) AS totall, IFNULL(y.espera_2, 0) AS espera, IFNULL(y.stock_2, 0) AS stock, IFNULL(y.proceso_2, 0) AS en_proceso, IF(a.capacidad_stock = 0, 0, FLOOR((SELECT stock) / a.capacidad_stock * 100)) AS pctstock, IF((SELECT cap_proceso) = 0, 0, FLOOR((SELECT en_proceso) / (SELECT cap_proceso) * 100)) AS pctproceso, IFNULL(y.calidad_2, 0) AS calidad FROM " + this.servicio.rBD() + ".cat_procesos a LEFT JOIN (SELECT proceso, SUM(capacidad) AS capproceso FROM " + this.servicio.rBD() + ".cat_maquinas WHERE estatus = 'A' GROUP BY proceso) AS z ON z.proceso = a.id LEFT JOIN (SELECT proceso, SUM(IF(estado <= 50, 1, 0)) AS totall_2, SUM(IF(estado = 0, 1, 0)) AS espera_2, SUM(IF(estado = 50, 1, 0)) AS proceso_2, SUM(IF(estado = 20, 1, 0)) AS stock_2, SUM(IF(estado = 80, 1, 0)) AS calidad_2 FROM " + this.servicio.rBD() + ".lotes WHERE estatus = 'A' GROUP BY proceso) AS y ON y.proceso = a.id " + (this.soloStock ? "HAVING totall > 0" : "") + " ORDER BY a.nombre;"
      
      this.sentenciaR = "SELECT '" + this.servicio.rTraduccion()[558] + "', '" + this.servicio.rTraduccion()[2582] + "', '" + this.servicio.rTraduccion()[698] + "', '" + this.servicio.rTraduccion()[1716] + "', '" + this.servicio.rTraduccion()[1715] + "', '" + this.servicio.rTraduccion()[2289] + "', '" + this.servicio.rTraduccion()[2606] + "', '" + this.servicio.rTraduccion()[2607] + "', '" + this.servicio.rTraduccion()[2608] + "', '" + this.servicio.rTraduccion()[2609] + "', '" + this.servicio.rTraduccion()[2610] + "', '" + this.servicio.rTraduccion()[2611] + "' UNION ALL SELECT a.id, a.nombre, a.referencia, a.capacidad_stock, IFNULL((SELECT SUM(capacidad) FROM " + this.servicio.rBD() + ".cat_maquinas WHERE proceso = a.id AND estatus = 'A'), 0) AS cap_proceso, (SELECT COUNT(*) FROM " + this.servicio.rBD() + ".lotes WHERE estado <= 50 AND estatus = 'A' AND proceso = a.id) AS totall, (SELECT COUNT(*) FROM " + this.servicio.rBD() + ".lotes WHERE estado = 0 AND estatus = 'A' AND proceso = a.id), (SELECT COUNT(*) FROM " + this.servicio.rBD() + ".lotes WHERE estado = 20 AND estatus = 'A' AND proceso = a.id) AS stock, IF(a.capacidad_stock = 0, 0, FLOOR((SELECT stock) / a.capacidad_stock * 100)), (SELECT COUNT(*) FROM " + this.servicio.rBD() + ".lotes WHERE estado = 50 AND estatus = 'A' AND proceso = a.id) AS proceso, IF((SELECT cap_proceso) = 0, 0, FLOOR((SELECT proceso) / (SELECT cap_proceso) * 100)), (SELECT COUNT(*) FROM " + this.servicio.rBD() + ".lotes WHERE estado = 80 AND estatus = 'A' AND proceso = a.id) FROM " + this.servicio.rBD() + ".cat_procesos a " + (this.soloStock ? "HAVING totall > 0" : "") + " ";
      if (this.vision==1)
      {
      ...
      {
        sentencia = "SELECT a.id, a.nombre, a.capacidad, a.proceso, IFNULL(b.nombre, '" + this.servicio.rTraduccion()[8] + "') AS nproceso, 'S' AS mostrarImagen, a.referencia, IFNULL(z.tlotes, 0) AS totall, IF(a.capacidad = 0, 0, FLOOR((SELECT totall) / a.capacidad * 100)) AS pctproceso FROM " + this.servicio.rBD() + ".cat_maquinas a LEFT JOIN " + this.servicio.rBD() + ".cat_procesos b ON a.proceso = b.id LEFT JOIN (SELECT equipo, COUNT(*) AS tlotes FROM " + this.servicio.rBD() + ".lotes WHERE estatus = 'A' AND estado = 50 GROUP BY equipo) AS z ON z.equipo = a.id " + (this.soloStock ? "HAVING totall > 0" : "") + " ORDER BY a.nombre;";
        this.sentenciaR = "SELECT '" + this.servicio.rTraduccion()[558] + "', '" + this.servicio.rTraduccion()[568] + "', '" + this.servicio.rTraduccion()[2612] + "', '" + this.servicio.rTraduccion()[2613] + "', '" + this.servicio.rTraduccion()[698] + "', '" + this.servicio.rTraduccion()[2614] + "', '" + this.servicio.rTraduccion()[2609] + "', '" + this.servicio.rTraduccion()[2286] + "'  UNION ALL SELECT a.id, a.nombre, a.proceso, IFNULL(b.nombre, '" + this.servicio.rTraduccion()[8] + "'), a.referencia, a.capacidad, (SELECT COUNT(*) FROM " + this.servicio.rBD() + ".lotes WHERE estatus = 'A' AND estado = 50 AND equipo = a.id) AS totall, IF(a.capacidad = 0, 0, FLOOR((SELECT totall) / a.capacidad * 100)) FROM " + this.servicio.rBD() + ".cat_maquinas a LEFT JOIN " + this.servicio.rBD() + ".cat_procesos b ON a.proceso = b.id " + (this.soloStock ? "HAVING totall > 0" : "") + " ";
